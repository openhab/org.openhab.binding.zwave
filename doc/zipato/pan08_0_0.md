...
<p&gtRoller shutter micromodule</p&gt

### Inclusion Information

<p&gtPut your Z-Wave controller into inclusion mode by following the instructions provided by the controller manufacturer.</p&gt <p&gtPressing Include button three times within 2 seconds will enter inclusion mode. </p&gt

### Exclusion Information

<p&gtPut the Z-Wave Controller in exclusion mode.</p&gt <p&gtPressing Include button three times within 2 seconds will enter exclusion mode.</p&gt <p&gtNode ID has been excluded.</p&gt
