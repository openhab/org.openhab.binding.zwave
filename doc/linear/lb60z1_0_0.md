...
<p&gtRadio Frequency Controlled Smart LED Light Bulb, 750 Lumens</p&gt

### Inclusion Information

<p&gtTurn the power to the light bulb socke ON</p&gt

### Exclusion Information

<p&gtSet  the  Controller  into  “exclusion”  mode.</p&gt <p&gtReset the bulb by using the wall switch to turn the power to the bulb ON. The Smart LED Light Bulb will flash twice to confirm the exclusion</p&gt
...
Dim Settings
<p&gtBy default, the LB60Z-1 bulb will go to full brightness when turned on. To have the bulb turn on to the last dim level setting, set parameter 1 to 1.</p&gt
