...
<p&gt300 Watt, 120 VAC NWI and Scene Capable Plug-In Lamp Module</p&gt

### Inclusion Information

<ol&gt<li&gtPrepare the Controller to include a unit to the network. The PD300Z-2 must be in its permanently installed location.</li&gt <li&gtFor NWI Inclusion, press the button on the PD300Z-2 once.</li&gt <li&gtFor classic inclusion, press the button on the PD300Z-2 twice.</li&gt </ol&gt

### Exclusion Information

<ol&gt<li&gtSet the Controller into Removal Mode</li&gt <li&gtRemove the switch by press the button twice</li&gt </ol&gt
...
<p&gtSet parameter to 0 to disable load sense, set parameter to 1 to enable load sense.</p&gt
