...
<p&gtThe WA00Z-1 Wall Mounted Switch is simple to set up and can be installed anywhere to operate other load bearing Z-Wave devices. </p&gt

### Inclusion Information

<p&gtPress either button on the WA00Z-1. The green LED should flash twice.</p&gt

### Exclusion Information

<p&gtRemove the switch by pressing either button on the WA00Z-1. The LED will flash twice indicating that it has been removed.</p&gt
...
<p&gtTap the top switch five times in rapid succession.</p&gt
...
<p&gtZ-Wave Plus introduces a new process for scene activation – “Central Scene <br /&gtControl”. Press and release the button, it will send a certain command to the <br /&gtcentral controller via the lifeline association group 1. This allows the controller <br /&gtto react to both a button press and a button release. This mode implements <br /&gtcommunication pattern 6, and requires a gateway supporting Z-Wave Plus.</p&gt
...
<p&gtYou can set the WA00Z-1 to control other devices or issue various scene activation commands to a central controller.</p&gt
The following option values may be configured -:
