...
<p&gtScene and NWI capable wall mounted switch</p&gt

### Inclusion Information

<ol&gt<li&gtWith your Controller in Discovery or Add Mode, tap the switch once for Network Wide Inclusion. Tap twice for Standard Inclusion.</li&gt <li&gtYou should see an indication on your Controller that the “device was added” to the network and the LED will stop blinking.</li&gt </ol&gt

### Exclusion Information

<ol&gt<li&gtSet the Controller into Removal Mode and follow its instruction to delete the WS15Z-1 from the Controller.</li&gt <li&gtRemove the switch by tapping the paddle 2 times.</li&gt <li&gtYou should see an indication on your Controller that the “device was removed” from the network.</li&gt </ol&gt
