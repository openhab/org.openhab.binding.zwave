...
<p&gtThis thermostat was made by Radio Thermostat Company of America or 2Gig.  It can use either WiFi or Z-Wave or both depending on <br /&gtwhich USNAP modules are installed.</p&gt

### Inclusion Information

<ul&gt<li&gtPut your primary controller in include mode.</li&gt <li&gtPress the MENU button</li&gt <li&gtTap the MATE button under the radio tower icon.  A large "r1" or "r2" wil be displayed indicating which slot the USNAP module is in.</li&gt <li&gtTap the MATE button under the radio tower icon again to include.</li&gt </ul&gt

### Exclusion Information

<ul&gt<li&gtPut your primary controller in exclude mode.</li&gt <li&gtPress the MENU button</li&gt <li&gtTap the MATE button under the radio tower icon.  A large "r1" or "r2" wil be displayed indicating which slot the USNAP module is in.</li&gt <li&gtTap the MATE button under the radio tower icon again to exclude.</li&gt </ul&gt
...
<p&gtSets the reporting threshold for changes in the ambient temperature as detected by the thermostat.</p&gt
...
Auxiliary/Emergency
<p&gtThe Auxiliary/Emergency configuration command enables or disables auxiliary / emergency heating in the thermostat. Auxiliary / emergency heating is only available if the thermostat is configured in heat pump mode and with at least one stage of auxiliary heat.</p&gt
The following option values may be configured -:
...
<p&gtThe Thermostat Swing Temperature configuration command sets swing temperature on the thermostat. The swing temperature is applied to the setpoint to determine when the thermostat will turn on the HVAC system. If the thermostat is heating, the swing temper</p&gt
The following option values may be configured -:
...
<p&gtThe Thermostat Differential Temperature configuration command sets the differential temperature for multi-stage HVAC systems. The differential temperature delta defines when the thermostat will turn on additional stages. There are two differential tempera</p&gt
The following option values may be configured -:
