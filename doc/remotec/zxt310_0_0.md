...
<p&gtZXT‐310 is a Z‐Wave‐to‐AV IR Extender (Figure 1) and it works with any Z‐Wave compliant controller or gateway by translating Z‐Wave Simple AV command </p&gt

### Inclusion Information

<p&gtPress the PROG button</p&gt
...
<p&gtUIRD formatted raw data for the Simple AV command number or key being downloaded or uploaded </p&gt
...
<p&gtReferred to Simple AV command class key ID</p&gt
Values in the range 0 to 0 may be set.
...
<p&gt<strong&gtThe status value 1, 3, 4 will be reset to 0 when ZXT‐310 receive a get command to this parameter </strong&gt</p&gt
