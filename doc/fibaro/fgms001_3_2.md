...
<p&gtFIBARO Motion Sensor is a universal Z-Wave multi-sensor. Along with detecting motion the device measures the temperature and light intensity. The sensor has a built-in accelerometer to detect any tampering of the device. FIBARO Motion Sensor is battery powered device and designed to be installed quickly and easily on any surface.</p&gt <p&gtThe LED indicator signals motion, temperature level, operating mode and can be used to see if device is within the Z-Wave network. The motion sensor can be used for lighting scenes and presence monitoring systems.</p&gt

### Inclusion Information

<p&gtQuickly, three times press the B-button</p&gt
...
<p&gtPress the B-button once</p&gt
...
<p&gtThe parameter defines the difference between night and day, in terms of light intensity, used in parameter 8. Available settings: 1 - 32767 Default setting: 200 (200 lux) Parameter size: 2 [bytes]</p&gt
Values in the range 1 to 32767 may be set.
...
<p&gtThis parameter defines how commands are sent in specified association groups: as secure or non-secure. Parameter is Active only in Z-Wave network security mode. It doesn’t apply to 1st Lifeline group.</p&gt <p&gtAvailable settings: 0 - 15<br /&gt0 - all groups sent as non-secure<br /&gt1 - 2nd group sent as secure<br /&gt2 - 3rd group sent as secure<br /&gt4 - 4th group sent as secure<br /&gt8 - 5th group sent as secure</p&gt <p&gtParameter values may be combined, e.g. 1+2=3 means that 2nd &<br /&gt3rd group are sent as secure.</p&gt <p&gtDefault setting: 15 (all groups sent as secure)<br /&gtParameter size: 1 [byte]</p&gt
Values in the range 0 to 15 may be set.
...
<p&gtThis parameter determines the change in force acting on the device, that will result in reporting tamper alarm - g-force acceleration.</p&gt <p&gtAvailable settigs: 0 - 121 (0.08 - 2g; multiply by 0.016g; 0 = tamper inactive)<br /&gtDefault setting: 15 (0.320g)<br /&gtParameter size: 1 [byte] </p&gt
...
<p&gtTime period after which a tamper alarm will be cancelled in the main controller and associated devices.</p&gt <p&gtAvailable settings: 1 - 32767<br /&gtDefault setting: 30 (seconds)<br /&gtParameter size: 2 [bytes] </p&gt
Values in the range 1 to 32767 may be set.
...
<p&gtThis parameter determines function of the tamper and sent reports. It is an advanced feature serving much more functions than just detection of tampering.</p&gt <p&gt0 – Only tamper (default)<br /&gt1 – Tamper and earthquake detector. Function may be used as a simple seismograph. Two reports including the strength of shock are<br /&gtalways sent. First, right after the detection and second (value=0) after tamper alarm cancellation delay time.<br /&gt2 – Tamper and orientation in space. Three reports are sent right after tamper alarm cancellation delay time.</p&gt
The following option values may be configured -:
...
<p&gt0 - Do not send tamper cancellation report<br /&gt1 - Send tamper cancellation report</p&gt
The following option values may be configured -:
...
Determines whether the tamper alarm frame will be sent in broadcast mode
<p&gtThe parameter determines whether the tamper alarm frame will or will not be sent in broadcast mode. Alarm frames sent in broadcast mode can be received by all of the devices within Communication range (if they accept such frames). When Fibaro Motion Sensor is operating in protected mode (secure mode), the value should remain default. Device operating in protected mode doesn’t send frames in broadcast mode.</p&gt <p&gt0 - Tamper alarm reported to association groups.<br /&gt1 - Tamper alarm reported in broadcast mode to 5th association group.</p&gt <p&gtDefault setting: 0<br /&gtParameter size: 1 [byte]</p&gt
The following option values may be configured -:
...
<p&gtThe parameter determines the change in light intensity level resulting in illumination report being sent to the main controller.</p&gt <p&gtAvailable settings: 0 - 32767 (1-32767 lux; 0=reports are not sent)</p&gt
...
<p&gtTime interval between consecutive illumination reports.<br /&gtThe reports are sent even if there are no changes in the light intensity.</p&gt <p&gtAvailable settings: 0 - 32767 (1-32767 seconds; 0 = no reports)<br /&gtDefault setting: 3600</p&gt
Values in the range 0 to 32767 may be set.
...
<p&gtThe parameter determines the change in level of temperature resulting in temperature report being sent to the main controller.<br /&gtAvailable settings: 0 - 255 (0.1 - 25.5oC; 0 = reports are not sent)<br /&gtDefault setting: 10 (1oC) Parameter size: 2 [byte]</p&gt
Values in the range 0 to 255 may be set.
...
<p&gtThe parameter determines how often the temperature reports will be sent to the main controller.<br /&gtAvailable settings: 0 - 32767 (1 - 32767 seconds; 0 = no reports)<br /&gtDefault setting: 0 Parameter size: 2 [byte] </p&gt
Values in the range 0 to 32767 may be set.
...
<p&gtThe value to be added to the actual temperature, measured by the sensor (temperature compensation).<br /&gtAvailable settings: -1000 – 1000 (-100-100°C, 0.1°C step)<br /&gtDefault setting: 0 Parameter size: 2 [bytes]</p&gt
...
<p&gtAMBIENT ILLUMINATION LEVEL BELOW WHICH LED BRIGHTNESS IS SET TO 1%</p&gt <p&gtThe parameter is relevant only when the parameter 81 is set to 0.<br /&gtAvailable settings: 0 to parameter 83 value<br /&gtDefault setting: 100 (100 lux)<br /&gtParameter size: 2 [bytes]</p&gt
Values in the range 0 to 32767 may be set.
...
<p&gtABOVE WHICH LED BRIGHTNESS IS SET TO 100%</p&gt <p&gtThe parameter is relevant only when the parameter 81 is set to 0.<br /&gtAvailable settings: parameter 82 value to 65535<br /&gtDefault setting: 1 000 (1 000 lux)<br /&gtParameter size: 2 [bytes]</p&gt
Values in the range 0 to 32767 may be set.
...
<p&gtThis parameter is relevant only when parameter 80 has been properly configured.<br /&gtAvailable settings: 0 to parameter 87 value (degrees celsius)<br /&gtDefault setting: 18 (18oC)<br /&gtParameter size: 2 [byte]</p&gt
Values in the range 0 to 255 may be set.
...
<p&gtThis parameter is relevant only when parameter 80 has been properly configured.<br /&gtAvailable settings: parameter 86 value to 255 (degrees celsius)<br /&gtDefault setting: 28 (28oC)<br /&gtParameter size: 2 [byte]</p&gt
Values in the range 0 to 255 may be set.
...
Device status
<p&gt"Lifeline" is a reporting group, assigned to the device status. Main Z-Wave+ network controller should be added to this group. The "Lifeline" group can handle only one device. If Fibaro Motion Sensor operates in protected mode, outgoing messages are always encrypted.</p&gt

Association group 1 supports 1 node.

### Group 2: Motion

<p&gt"Motion" is assigned to the motion sensor. At the moment of motion detection or alarm state cancellation, nodes added to this group will receive control frames. The "Motion" group can handle up to five devices (one or multi-channel). If Fibaro Motion Sensor operates in protected mode, outgoing messages are encrypted, depending on whether the added node also operates in secure mode.</p&gt

Association group 2 supports 5 nodes.

### Group 3: Tamper

<p&gt"Tamper" is assigned to the tamper alarm. Once tampering is detected or cancelled, nodes added to this group will receive alarm frames. The "Tamper" group can handle up to five devices (one or multi-channel). If Fibaro Motion Sensor operates in protected mode, outgoing messages are always encrypted.</p&gt
...
<p&gt"Tamper BC" is assigned to the tamper alarm. Once tampering is detected or cancelled, nodes added to this group will receive alarm frames. This group aims to provide backward compatibility with devices not supporting the Z-Wave+ protocol. Only nodes not supporting the Z-wave+ protocol should be added to this group. The "Tamper BC" group can handle up to five devices (one or multi-channel). If Fibaro Motion Sensor operates in protected mode, outgoing messages are always encrypted. The Fibaro Motion Sensor allows for controlling 5 regular and 5 multichannel devices per an association group, out of which 1 field is reserved for the Z-Wave network main controller.</p&gt
