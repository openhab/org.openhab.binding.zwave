...
<p&gtRemotely controlled light dimming module is designed to work with various types of light sources. It may be connected to two-wire or three-wire configuration so it can operate with or without neutral lead. FIBARO Dimmer 2 can switch or dim connected light source either through radio waves or through the wall switch connected directly to it.</p&gt <p&gtNew FIBARO Dimmer 2 is equipped with an algorithm of smart light source detection which makes configuration easier and ensures high compatibility of the device. It may be used as a switch with nondimmable light sources (in 3-wire connection).</p&gt <p&gt<strong&gtMain features of FIBARO Dimmer 2:</strong&gt</p&gt <ul&gt<li&gtCompatible with any Z-Wave or Z-Wave+ Controller</li&gt <li&gtControlled by FIBARO Home Center or any other Z-Wave controller</li&gt <li&gtAdvanced microprocessor control, • Implemented algorithm of smart light source detection</li&gt <li&gtAuto-adjustment of the appropriate control mode to connected load</li&gt <li&gtActive power and energy metering functionality</li&gt <li&gtSoft start function, • Memory of the last lighting level settings</li&gt <li&gtWorks with various types of switches – momentary, toggle, three-way, etc</li&gt <li&gtActive element: semiconductor electronic switch</li&gt <li&gtTo be installed in wall switch boxes of dimensions allowing for installation, conforming to provisions of applicable regulations</li&gt <li&gtFGD-212 is an extension unit.</li&gt </ul&gt
...
<ol&gt<li&gtPlace the Dimmer 2 within the direct range of your Z-Wave controller.</li&gt <li&gtIdentify switch no. 1 (turns the light on) or the B-button (located on the device’s housing).</li&gt <li&gtSet the main controller in remove mode (see the controller’s manual).</li&gt <li&gtQuickly, three times press switch no. 1 or the B-button.</li&gt <li&gtWait for the removing process to end.</li&gt <li&gtSuccessful removing will be confirmed by the Z-Wave controller’s message.</li&gt <li&gtDimmer 2 will start the calibration process.</li&gt </ol&gt
...
<p&gtSet to 1 to enable S2 input or 0 to disable</p&gt
...
<p&gtVirtual value set as a percentage level between parameters MIN (1%) and MAX. (99%). The Dimmer 2 will set to this value after first switch on. It is required for warming up and switching dimmable compact fluorescent lamps and certain types of light sources.</p&gt <p&gt*CFL: compact fluorescent lamps</p&gt
Values in the range 1 to 99 may be set.
...
<p&gtIncandescence time of dimmable compact fluorescent lamps</p&gt <p&gtThis parameter determines the time required for switching compact fluorescent lamps and certain types of light sources. Setting this parameter to 0 will disable the incandescence functionality. Available settings: 0-255 (0s - 25,5s).</p&gt <p&gt*CFL: compact fluorescent lamps</p&gt
...
<p&gtThe parameter defines the setting of the timer. Available settings:1-32767 - time to turn off measured in seconds (1s - 9,1h), 0 disables the function</p&gt
...
<p&gtThis parameter specifies the duration of Brightness level correction for flickering loads in seconds. 255 sets the function to "always enabled". 0 disables the function.<br /&gtCorrection reduces spontaneous flickering of some capacitive load (e.g. dimmable LEDs) at certain brightness levels in 2-wire installation.<br /&gtIn countries using ripple-control, correction may cause changes in brightness. In this case it is necessary to disable correction or adjust time of correction for flickering loads.</p&gt
Values in the range 0 to 255 may be set.
...
<p&gtOVERHEAT (critical temperature) and VOLTAGE DROP (low voltage) alarm report</p&gt
The following option values may be configured -:
...
<p&gtSends BASIC SET command class frame according to the state of the device</p&gt
