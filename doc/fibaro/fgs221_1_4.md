...
<p&gtAutomatic turning off relay 1 after set time, in 10ms increments (default: 200ms)</p&gt
...
<p&gtAutomatic turning off relay 2 after set time, in 10ms increments (default: 200ms)</p&gt
Values in the range 0 to 255 may be set.
...
<p&gtActivate/Deactivate association sending for group 1 - activate param #15 for this to work</p&gt
The following option values may be configured -:
...
<p&gtActivate/Deactivate association sending for group 2 - activate param #15 for this to work</p&gt
The following option values may be configured -:
...
<p&gtEnable/Disable operation of dimmer or roller shutter devices associated to group 1. Available only when using mono-stable inputs (buttons) - Hold button 1 or double-tap for operation</p&gt
The following option values may be configured -:
