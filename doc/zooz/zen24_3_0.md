...
<ul&gt<li&gtManual or Z-Wave on/off and brightness control</li&gt <li&gt<strong&gtDirect 3-way:</strong&gt worke with regular on/off switches in a 3-way (neutral wire required)</li&gt <li&gtFully adjustable ramp rate for just the right on/off speed</li&gt <li&gtDouble tap to full brightness feature</li&gt <li&gt<strong&gtNEW:</strong&gt optional scene control</li&gt <li&gtRemembers and restores on/off status after power failure</li&gt <li&gtBuilt-in Z-Wave Plus signal repeater to extend network range</li&gt <li&gtWorks with LED and incandescent bulbs (don't use with fans or tubes)</li&gt </ul&gt

### Inclusion Information

<p&gtToggle the switch up 5 or 6 times very quickly when adding it.</p&gt

### Exclusion Information

<p&gtToggle the switch down 3 times quickly</p&gt
...
<p&gtChoose if you want the to turn the light on by clicking the toggle up or down.</p&gt
...
<p&gtEnable or disable the auto turn-off timer function.</p&gt
The following option values may be configured -:
...
<p&gtThe number is in minutes.</p&gt <p&gtDefault: 60 minutes</p&gt
...
<p&gtenable or disable the auto turn-on timer function.</p&gt
The following option values may be configured -:
...
<p&gtnumber is in minutes</p&gt <p&gtDefault: 60 minutes</p&gt
Values in the range 1 to 65535 may be set.
...
Ramp Rate Control
<p&gtNumber of seconds for the dimmer to reach full brightness or turn off when operated manually.</p&gt <p&gtDefault: 1 second</p&gt
...
Minimum Brightness
<p&gtMinimum brightness level (in %) for your dimmer.</p&gt
Values in the range 1 to 99 may be set.
...
Maximum Brightness
<p&gtMaximum brightness level (in %) for your dimmer.</p&gt
Values in the range 1 to 99 may be set.
...
<p&gtEnable or disable scene control for quick double tap triggers.</p&gt <p&gtFind out how to make scene control work at www.support.getzooz.com</p&gtThis is an advanced parameter and will therefore not show in the user interface without entering advanced mode.
The following option values may be configured -:
...
<p&gtEnable or disable the double-tap function and assign brightness level to single tap.</p&gtThis is an advanced parameter and will therefore not show in the user interface without entering advanced mode.
The following option values may be configured -:
