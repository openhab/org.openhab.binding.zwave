...
<p&gt<strong&gtFeatures</strong&gt</p&gt <ul&gt<li&gtPowerful dry contact relays to control loads up to 15 A and 20 A</li&gt <li&gtPerfect for outdoor lighting, pool pumps, garage door, or gas fireplace</li&gt <li&gtControl up to 3 connected loads independently or together</li&gt <li&gtZ-Wave or optional wall switch control (toggle or momentary type)</li&gt <li&gtBuilt-in timers for each relay to simplify automation</li&gt <li&gtRemembers and restores on/off status after power failure</li&gt <li&gtBuilt-in Z-Wave Plus signal repeater to extend network range</li&gt <li&gtPowered by 12-24 V DC/AC or USB C port for easy set-up</li&gt <li&gtWall mounting and minimal design for clean installation</li&gt <li&gtS2 security protocol and the latest 500 Z-Wave chip</li&gt </ul&gt<p&gt<strong&gtSpecifications</strong&gt</p&gt <ul&gt<li&gtModel Number: ZEN16</li&gt <li&gtZ-Wave Signal Frequency: 908.42 MHz</li&gt <li&gtPower: 12-24 V DC/AC or USB C</li&gt <li&gtMaximum Load: Relay 1: 15A (HP), R2: 15A (HP), R3: 20A (HP)</li&gt <li&gtRange: Up to 100 feet line of sight</li&gt <li&gtOperating Temperature: 32-104° F (0-40° C)</li&gt <li&gtInstallation and Use: Indoor only</li&gt </ul&gt

### Inclusion Information

<ol&gt<li&gtStart Z-Wave inclusion.</li&gt <li&gtQuickly press the Z-Wave button 3 times.</li&gt </ol&gt<p&gtThe LED indicator will blink to signal communication and remain on for 2 seconds to confirm inclusion.</p&gt

### Exclusion Information

<ol&gt<li&gtBring the Multirelay close to the Z-Wave controller and then supply power to it.</li&gt <li&gtPut the Z-Wave binding into exclusion mode.</li&gt <li&gtQuickly press the Z-Wave button 3 times.</li&gt </ol&gt

### General Usage Information

<p&gtIf your primary controller is missing or inoperable, you may need to reset the device to factory settings. To complete the reset process manually, click the Z-Wave button 4 times quickly, the LED indicator will light up, then quickly click the Z-Wave button 4 times again. The LED indicator will flash 3 times to confirm successful reset and will then turn off.</p&gt <p&gtNOTE: All previously recorded activity and custom settings will be erased from the device’s memory.</p&gt
...
<p&gtPress and hold the Z-Wave button for 5 seconds to change mode manually</p&gt
The following option values may be configured -:
...
<p&gtClick-click’n’hold the Z-Wave button for 5 seconds to change mode manually.</p&gt
The following option values may be configured -:
...
<p&gtClick-click-click’n’hold the Z-Wave button for 5 seconds to change mode manually</p&gt
The following option values may be configured -:
...
<p&gtChoose if you want the LED indicator to turn on when any of the relays are on or if all of them are off, or if you want it to remain on or off at all times.</p&gt <p&gtClick the Z-Wave button 5 times quickly to change mode manually</p&gt
The following option values may be configured -:
...
<p&gtUse this parameter to set the time after which you want the device connected to Relay 1 to automatically turn off once it has been turned on. The number entered as value corresponds to the number of minutes.</p&gt
...
<p&gtUse this parameter to set the time after which you want the device connected to Relay 1 to automatically turn on once it has been turned off. The number entered as value corresponds to the number of minutes.</p&gt
The following option values may be configured, in addition to values in the range 0 to 65535 -:
...
<p&gtUse this parameter to set the time after which you want the device connected to Relay 2 to automatically turn off once it has been turned on. The number entered as value corresponds to the number of minutes.</p&gt
The following option values may be configured, in addition to values in the range 0 to 65535 -:
...
<p&gtUse this parameter to set the time after which you want the device connected to Relay 2 to automatically turn on once it has been turned off. The number entered as value corresponds to the number of minutes.</p&gt
The following option values may be configured, in addition to values in the range 0 to 65535 -:
...
<p&gtUse this parameter to set the time after which you want the device connected to Relay 3 to automatically turn off once it has been turned on. The number entered as value corresponds to the number of minutes.</p&gt
The following option values may be configured, in addition to values in the range 0 to 65535 -:
...
<p&gtUse this parameter to set the time after which you want the device connected to Relay 3 to automatically turn on once it has been turned off. The number entered as value corresponds to the number of minutes.</p&gt
The following option values may be configured, in addition to values in the range 0 to 65535 -:
...
<p&gtEnable or disable physical on/off control of Relay 1 from the wall switch connected to Sw1 terminal. If disabled, you’ll only be able to control the connected device via Z-Wave.</p&gt
The following option values may be configured -:
...
<p&gtEnable or disable physical on/off control of Relay 2 from the wall switch connected to Sw2 terminal. If disabled, you’ll only be able to control the connected device via Z-Wave.</p&gt
The following option values may be configured -:
...
<p&gtEnable or disable physical on/off control of Relay 3 from the wall switch connected to Sw3 terminal. If disabled, you’ll only be able to control the connected device via Z-Wave.</p&gt
The following option values may be configured -:
