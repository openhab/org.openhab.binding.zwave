...
## Channels
The following table summarises the channels available for the swiidplug SwiidPlug.
...
The following table provides a summary of the configuration parameters available in the swiidplug SwiidPlug.
