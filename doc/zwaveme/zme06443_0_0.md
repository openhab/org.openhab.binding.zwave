...
<p&gtThe battery wall controller is a Z-Wave device that can act as controller. This means that it can built its own Z-Wave network by including and managing other devices but it can also be included into a different Z-Wave controllers network and act as a secondary controller.</p&gt <p&gtThe rocker can be used to control other Z-Wave devices or send scene control command to an IP gateway. The device has two independent control channels - in Z-Wave language Association groups – that can be operated by single and double click of the rocker.</p&gt

### Inclusion Information

<p&gtPress the button “Inclusion” for 2 seconds. The LED will start shining green.</p&gt

### Exclusion Information

<p&gtTriple click the button “Exclusion”. The LED will start blinking. </p&gt
...
<p&gtTriple click on either the button “Down” or the button “Up” will issue a Node Information Frame and keep the device awake for 2 sec afterwards.</p&gt
...
<p&gtTypical time used to differentiate click, hold, double and triple clicks</p&gt <p&gtDefined in 10ms ticks.</p&gt
...
<p&gtDefines which command should be sent on button single press or hold.</p&gt <p&gtBasic and Scene commands are sent to Association group.</p&gt <p&gtSwitch All commands are sent broadcast.</p&gt <p&gtScenes have following meaning: Up = 1, Down = 2, Dim Up = 3, Dim Down = 4, Dim Up Stop = 5</p&gt
...
<p&gtDefines which command should be sent on button double press or press-hold.</p&gt <p&gtBasic and Scene commands are sent to Association group.</p&gt <p&gtSwitch All commands are sent broadcast.</p&gt <p&gtIf not disabled, the device will wait for a click timeout to see if the second click</p&gt
The following option values may be configured -:
