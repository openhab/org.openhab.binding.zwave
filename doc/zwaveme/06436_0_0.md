...
<p&gtDefines how to interpret button Down press. Depends on "Switch by buttons" parameter.</p&gt <p&gtIf not Disabled this parameter will affect the action selected by the latter parameter. Can be used in conjunction with Auto Off function.</p&gt
The following option values may be configured -:
