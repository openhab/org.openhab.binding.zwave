...
<p&gtThe Danfoss Link™ RS (Room Sensor) has a built-in temperature sensor, which measures the ambient temperature. It allows you to control the heating, based on room temperature in the room where installed. With the Danfoss Link™ RS you can also adjust the temperature.</p&gt

### Inclusion Information

<p&gtPush one time LED Button</p&gt
...
<p&gtAny button (LED, Temp+ or Temp-)</p&gt
