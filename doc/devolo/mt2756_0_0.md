...
<p&gtThe Home Control Water Sensor is a water sensor and warns you about flooding or leaking water. As soon as water touches the open metal contacts, the device triggers an alarm. The Home Control Water Sensor is ideal for use in locations such as under a sink, under the supply valve of a washing machine or on an aquarium. It is equipped with an integrated LED and a release button.</p&gt

### Inclusion Information

<ul&gt<li&gtPressing the tamper key three times within 1.5  seconds to enter the inclusion mode.</li&gt <li&gtAfter add successful, the device will wake to receive the setting command from Z-Wave™  Controller about 20 seconds.</li&gt </ul&gt

### Exclusion Information

<p&gtPress tamper key three times within 1.5 seconds to enter the exclusion mode.</p&gt
...
Basic Set OFF Level
<p&gtSetting the BASIC command value</p&gt <ul&gt<li&gtWhen the flood trigger off(0x00), send the BASIC CC to the group 2</li&gt </ul&gt
...
Basic Set ON Level
<p&gtSetting the BASIC command value</p&gt <ul&gt<li&gtWhen the flood trigger on(0xFF), send the BASIC CC to the group 2</li&gt </ul&gt
Values in the range 0 to 255 may be set.
...
<p&gtOperation mode</p&gt <ul&gt<li&gt0: Flood function is enabled</li&gt <li&gt1: Flood function is disabled</li&gt </ul&gt
...
Customer Function
<p&gtParameter to set the sensor functions</p&gt <ul&gt<li&gtBit 0: Reserve</li&gt <li&gtBit 1: Reserve</li&gt <li&gtBit 2: Reserve</li&gt <li&gtBit 3: Disable send out BASIC OFF after the flood event cleared</li&gt <li&gtBit 4: Notification Type. <ul&gt<li&gt0:Using Notification Report,</li&gt <li&gt1:Using Sensor Binary Report</li&gt </ul&gt</li&gt <li&gtBit 5: Disable Multi CC in aut</li&gt </ul&gt
Values in the range 0 to 255 may be set.
...
<p&gtThe interval time for auto reporting the battery level</p&gt <ul&gt<li&gt0 = Turn off auto report battery.</li&gt <li&gt1-127 = Number of ticks.</li&gt </ul&gt<p&gtThe default value is 12. The tick time can be set by configuration No. 20.</p&gt
...
<p&gtThe interval time for auto report the flood state</p&gt <ul&gt<li&gt0 = Turn off auto report</li&gt <li&gt1-127 = Number of ticks.</li&gt </ul&gt<p&gtThe default value is 12. The tick time can be set by configuration No. 20</p&gt
Values in the range 0 to 127 may be set.
...
<p&gtThe interval time for auto reporting each tick.</p&gt <ul&gt<li&gt0 = Turn off all auto report function.</li&gt <li&gt1-255 = Number of ticks.</li&gt </ul&gt<p&gtSetting this configuration will effect configuration Nr. 10 and No. 15.</p&gt
Values in the range 0 to 255 may be set.
