...
<p&gtThe Home Control Wall Switch lets you control your Home Control devices at the press of a button. It has two<br /&gtdifferent rocker switches.</p&gt

### Inclusion Information

<p&gtActivate inclusion on the device by pressing any one of the four buttons for one second.</p&gt

### Exclusion Information

<p&gtActivate exclusion on the device by pressing any one of the four buttons for one second.</p&gt
...
<p&gtClick button 2 in management mode.</p&gt
...
<p&gtIn separate mode button 1 works with group 1, button 3 with groups 3. Click is On, Hold is dimming Up, Double click is Off, Click-Hold is dimming Down. In pair button 1/3 are Up/Down correspondingly. Click is On/Off, Hold is dimming Up/Down. Single clicks works with group 1, double click with group 3.</p&gt
...
<p&gtIn separate mode button 2 works with group 2, button 4 with groups 4. Click is On, Hold is dimming Up, Double click is Off, Click-Hold is dimming Down. In pair button 2/4 are Up/Down correspondingly. Click is On/Off, Hold is dimming Up/Down. Single clicks works with group 2, double click with group 4.</p&gt
The following option values may be configured -:
...
<p&gtDefines the command to be sent to devices of control group A when the related button is pressed.</p&gt <p&gtIn Switch On/Off only mode On command is sent on Dim Up, Off on Dim Down. In Scenes mode the scene ID sent is (10 * group + ActionID), where ActionID is: 1 = On, 2 = Off, 3 = Dim Up Start, 4 = Dim Down Start, 5 = Dim Up Stop, 6 = Dim Down Stop</p&gt
The following option values may be configured -:
...
<p&gtDefines the command to be sent to devices of control group B when the related button is pressed.</p&gt <p&gtIn Switch On/Off only mode On command is sent on Dim Up, Off on Dim Down. In Scenes mode the scene ID sent is (10 * group + ActionID), where ActionID is: 1 = On, 2 = Off, 3 = Dim Up Start, 4 = Dim Down Start, 5 = Dim Up Stop, 6 = Dim Down Stop</p&gt
The following option values may be configured -:
...
<p&gtDefines the command to be sent to devices of control group C when the related button is pressed.</p&gt <p&gtIn Switch On/Off only mode On command is sent on Dim Up, Off on Dim Down. In Scenes mode the scene ID sent is (10 * group + ActionID), where ActionID is: 1 = On, 2 = Off, 3 = Dim Up Start, 4 = Dim Down Start, 5 = Dim Up Stop, 6 = Dim Down Stop</p&gt
The following option values may be configured -:
...
<p&gtDefines the command to be sent to devices of control group D when the related button is pressed.</p&gt <p&gtIn Switch On/Off only mode On command is sent on Dim Up, Off on Dim Down. In Scenes mode the scene ID sent is (10 * group + ActionID), where ActionID is: 1 = On, 2 = Off, 3 = Dim Up Start, 4 = Dim Down Start, 5 = Dim Up Stop, 6 = Dim Down Stop</p&gt
The following option values may be configured -:
...
<p&gtControl Group A, controlled by button 1 or single clicks of buttons 1</p&gt
