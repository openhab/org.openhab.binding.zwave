...
<p&gtYou can use the Home Control Key-Fob Switch for conveniently controlling your Home Control devices at the touch of a button.</p&gt

### Inclusion Information

<p&gtIn factory default mode pushing one of the four buttons for 1 sec will start different inclusion modes:</p&gt <ul&gt<li&gtButton 1: Include (Add) KFOB as sec. controller</li&gt <li&gtButton 2: Include (add) KFOB as secondary controller - non secure</li&gt <li&gtButton 3: Include (add) new device into KFOBS network</li&gt <li&gtButton 4: Include (add) new device into KFOBS network - non secure</li&gt </ul&gt<p&gtThe process for button 1 and 2 are indicated with fast red/green blinking, the process for button 3 and 4 show a fast green blinking. Every button push stops the process.</p&gt <p&gtThis fast inclusion only works when device is in factory default. Once one device is included or the fob is included as secondary controller further inclusion and exclusion operation require to turn the device into management mode</p&gt <p&gtIn management mode</p&gt <ul&gt<li&gtButton 1: Include or Exclude the device as secondary controller</li&gt <li&gtButton 2: Issue Wakeup Notification and send out Node Information Frame</li&gt <li&gtButton 3 followed by short click of button 1: Start Secure Inclusion</li&gt <li&gtButton 3 followed by short click of button 2: Start Unsecure Inclusion</li&gt <li&gtButton 3 followed by short click of button 3: Start Exclusion</li&gt <li&gtButton 3 followed by short click of button 4: Start Primary Handover</li&gt </ul&gt

### Exclusion Information

<p&gtLeaving the network - i.e. being excluded - sets the device back to factory default.</p&gt <p&gtIn management mode the following actions can be performed:</p&gt <ul&gt<li&gt<strong&gtButton 3 followed by short click </strong&gt<strong&gtof button 3:</strong&gt Start Exclusion (Remove)</li&gt <li&gt<strong&gtButton 3 followed by pushing </strong&gt<strong&gtbutton 4 for 5 seconds</strong&gt: Factory Default Reset. After clicking on button 3 keep button 4 pushed for 4 seconds</li&gt </ul&gt
...
<p&gtIn separate mode button 1 works with group 1, button 3 with groups 3. Click is On, Hold is dimming Up, Double click is Off, Click-Hold is dimming Down.</p&gt <p&gtIn pair button 1/3 are Up/Down correspondingly. Click is On/Off, Hold is dimming Up/Down. Single clicks</p&gt
...
<p&gtIn separate mode button 1 works with group 2, button 4 with groups 3. Click is On, Hold is dimming Up, Double click is Off, Click-Hold is dimming Down.</p&gt <p&gtIn pair button 2/4 are Up/Down correspondingly. Click is On/Off, Hold is dimming Up/Down. Single clicks</p&gt
The following option values may be configured -:
