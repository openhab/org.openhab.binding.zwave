...
<p&gtThe Z-Wave Thermostat (GC-TBZ48) is a programmable, Z-Wave communicating thermostat. It can be powered using 24VAC (if both “R”&”C”wires are available at the thermostat), or using four (4) AA batteries. Using Z-Wave technology, end users have the ability to use the 2GIG Go!Control panel to control the thermostat, configure programming settings, as well as to display current conditions in the home or office.</p&gt

### Inclusion Information

<ol&gt<li&gtPress any button to take thermostat out of sleep mode.</li&gt <li&gtPress and hold FAN button for 5 seconds. SETUP will be displayed in the status display line.</li&gt <li&gtScroll to “Z-Wave” using up & down buttons. Press SELECT.</li&gt <li&gtWhen prompted by your Z-Wave controller, Press the YES button on in the Z-Wave Install screen.</li&gt <li&gtPress SELECT (mode button) to add thermostat to network</li&gt </ol&gt
