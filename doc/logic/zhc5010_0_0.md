...
<p&gt0: Separate mode (toggle mode)</p&gt <p&gt1: In pair mode, left side sends on/up commands, right side sends off/down commands</p&gt
...
<p&gtSends Binary Switch Set (On/Off) when button #1 is used.</p&gt

Association group 4 supports 5 nodes.

### Group 5: Binary Toggle Sw Set btn #1

<p&gtSend Binary Toggle Switch Set when button #1 is used.</p&gt

Association group 5 supports 5 nodes.

### Group 7: Basic Report btn #2

<p&gtSend Basic Report (On/Off) when button #2 is used.</p&gt

Association group 7 supports 5 nodes.

### Group 8: Basic Set btn #2

<p&gtSends Basic Set (On/Off) when button #2 is used.</p&gt
...
<p&gtSend Binary Toggle Switch Set when button #2 is used.</p&gt
...
<p&gtSends Binary Switch Set (On/Off) when button #3 is used.</p&gt

Association group 14 supports 5 nodes.

### Group 15: Binary Toggle Switch Set btn #3

<p&gtSend Binary Toggle Switch Set when button #3 is used.</p&gt
...
<p&gtSends Binary Switch Set (On/Off) when button #4 is used</p&gt

Association group 19 supports 5 nodes.

### Group 20: Binary Toggle Switch Set btn #4

<p&gtSend Binary Toggle Switch Set when button #4 is used</p&gt
