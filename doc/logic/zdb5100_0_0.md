...
|  Colour commands for pushbutton 1 LED indication. | config_decimal | config_decimal |  | Number | 
| Colour commands for pushbutton 2 LED indication | config_decimal | config_decimal |  | Number | 
| Colour commands for pushbutton 3 LED indication. | config_decimal | config_decimal |  | Number | 
| Colour commands for pushbutton 4 LED indication. | config_decimal | config_decimal |  | Number | 
...
###  Colour commands for pushbutton 1 LED indication.
