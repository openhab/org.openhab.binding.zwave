...
<p&gtMinoston MS12Z - a simple on/off switch with timer capabilities</p&gt

### Inclusion Information

<p&gtPress the up or down button three times quickly to ADD and REMOVE</p&gt
...
<ul&gt<li&gtPress the up or down button three times quickly to ADD and REMOVE</li&gt <li&gtPress the up or down button six times quickly to change Status LED Configuration</li&gt <li&gtPress click Z-Wave button3 times quickly,and hold the third time for at least 10 seconds. to restore the device to the factory.</li&gt <li&gt(Node:Please use this procedure only when the network primary controller is missing or otherwise inoperable.)</li&gt </ul&gt
