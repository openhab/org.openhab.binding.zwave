...
<p&gtExtend the bolt on the lock and then perform the following:</p&gt <p&gtEnter 6 Digit Programming Code, then press 0. There will be a green check mark if enrolled or a red X if not enrolled<br /&gt<br /&gtTo verify enrollment:<br /&gt1. Remove the battery cover. See Replacing the Batteries on page 4 of the User Guide.<br /&gt2. Disconnect the battery connector.<br /&gt3. While watching the inside Schlage button, reconnect the battery connector.<br /&gt4. The inside Schlage button will blink if the lock is enrolled.</p&gt
