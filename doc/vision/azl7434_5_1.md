...
<p&gtIn-wall switch 1-relay</p&gt

### Inclusion Information

<p&gtPress 3 times on Program button within 2 seconds or turn on the wall switch 3 times within 2 seconds.</p&gt

### Exclusion Information

<p&gtPress 3 times on Program button within 2 seconds or turn on the wall switch within 2 seconds</p&gt
...
Mode
<p&gtConfiguration Value:</p&gt <p&gt"1" -To Control Light with 1 Wall Switch & to Control Light With 2 WallSwitches.</p&gt <p&gt"2"-To Control Light with 1 Wall Switch That Has Light Indicator (factory default).</p&gt
...
Switch Type
<p&gtConfiguration Value:</p&gt <p&gt"1" –With common on/off type switch button used(factory default).</p&gt <p&gt"2"–With momentary type switch button used.</p&gt
Values in the range 1 to 2 may be set.
