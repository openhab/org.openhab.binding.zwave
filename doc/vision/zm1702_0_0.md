...
<p&gtThe ZM1702 is a Z-Wave controllable, single dead bolt lock. The mechanics can be adopted to right or left opening doors. The door lock can be applied for doors from a thickness of 38 mm and up. The door can be locked and unlocked using the inner side turn piece and/or the key pad. The wireless control allows to lock/unlock the lock, set/unset up to 15 different key codes (4 - 8 key long) and to limit the validity of certain key code.</p&gt

### Inclusion Information

<p&gtPress Keypads 'C', '8', '8', '8' and manually turn the door lock from inside to be included.</p&gt

### Exclusion Information

<p&gtPress Keypads 'C', '8', '8', '8' and manually turn the door lock from inside to be excluded.</p&gt
...
<p&gtSupport one group (5 nodes). ZM1702 will report back every time lock and unlock status. </p&gt
