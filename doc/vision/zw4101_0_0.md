...
<p&gtDrapery controller, supports up/stop/down commands.</p&gt <p&gtDevices is OEMed as Monoprice 11993.</p&gt

### Inclusion Information

<p&gtPress the program switch on the module once to be included.</p&gt

### Exclusion Information

<p&gt Press the program switch on the module once to be excluded.</p&gt
...
Up output time
<p&gtTime to hold the "up" output button closed (shorted) when unit receives an "up" z-wave command.</p&gt
...
Stop output time
<p&gtTime to hold the "stop" output button closed (shorted) when unit receives a "stop" z-wave command.</p&gt <p&gtNote that the unit will automatically execute STOP, UP or STOP, DOWN when receiving an up or down command.</p&gt
Values in the range 1 to 255 may be set.
...
Down output time
<p&gtTime to hold the "down" output button closed (shorted) when unit receives a "down" z-wave command.</p&gt
Values in the range 1 to 255 may be set.
