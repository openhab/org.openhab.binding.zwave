...
<p&gtThis detector is designed to sense smoke that comes into the detector chamber and send Z-Wave™ signal when the detector detects a certain density of smoke then the horn of smoke detector will sound. </p&gt

### Inclusion Information

<p&gtPress the program switch for 1 second at least</p&gt
