...
<p&gtContact/temperature/humidity/luminance sensor.  Can also be called Zipato Quad Sensor (Z+).</p&gt

### Inclusion Information

<p&gt Press the program switch once on Multisensor 4 in 1</p&gt

### Exclusion Information

<p&gt Press the program switch once on Multisensor 4 in 1 for 1 second at least</p&gt
...
<p&gtThreshold change in temperature to induce an automatic report. 1 to 50 ( Set up from 0.1C to 5C)</p&gt
...
Set up from 1%-50%
<p&gtThreshold change in humidity to induce an automatic report. 1 to 50 ( Set up from 1%-50%)</p&gt
Values in the range 1 to 50 may be set.
...
Set up from 5%-50%
<p&gtThreshold change in luminance to induce an automatic report. 0 is disabled. 5 to 50 ( Set up from 5%-50%)</p&gt
