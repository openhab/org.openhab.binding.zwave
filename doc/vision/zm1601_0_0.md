...
<p&gtThis product will sound a loud siren and flash a strobe light when an alarm message or alert is received on any Z-Wave enabled network. </p&gt

### Inclusion Information

<p&gtOpen the bracket and press the program switch of ZM 1601 for 1 second at least & release to be included. After setting, the LED Setting Lighting should go off, if not, please try again.</p&gt

### Exclusion Information

<p&gtPress the program switch of ZM 1601 for 1 second at least & release to be excluded.</p&gt <p&gtNote: LED setting light will flash (orange color) continuously in Exclusion condition. </p&gt
