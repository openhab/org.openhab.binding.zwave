...
<p&gtLamp Dimmer Module</p&gt

### Inclusion Information

<p&gtPress and hold the program button on the front for about 1 second to include the device in the Z-Wave network.</p&gt

### Exclusion Information

<p&gtPress and hold the program button on the front for about 1 second to exclude the device from the Z-Wave network.</p&gt
