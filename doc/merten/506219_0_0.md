...
<p&gt<strong&gtSingle-surface push-button:</strong&gt</p&gt <p&gtTop button: Association Group = 1 Parameter no. = 0</p&gt <p&gtBottom button: Association Group = 2 Parameter no. = 1</p&gt <p&gt<strong&gtDual-surface push-button:</strong&gt</p&gt <p&gtLeft top button: Association Group = 1 Parameter no. = 0</p&gt <p&gtLeft bottom button: Association Group = 2 Parameter no. = 1</p&gt <p&gtRight top button: Association Group = 3 Parameter no. = 2</p&gt <p&gtRight bottom button: Association Group = 4 Parameter no. = 3</p&gt <p&gt<strong&gtTransmit "Node info frame"</strong&gt</p&gt <p&gtTriple click on operating surface Wait until the red LED D goes out. Used to identify, associate and configure the device</p&gt

### Inclusion Information

<p&gtTriple click on operating surface LED flashes approx. 6 seconds. Used for include/exclude the device by the primary</p&gt
