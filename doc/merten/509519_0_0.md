...
<p&gtMovement/presence detectors switch on as soon as they detect a moving heat source. This can be a person, but also animals, trees, cars or differences in temperature in windows. In order to avoid false alarms, the chosen installation site should be such that undesired heat sources cannot be detected (see section „Selecting the installation site“). </p&gt

### Inclusion Information

<p&gtTurn the controller A on the ARGUS to position B: The learning mode is activated. </p&gt
