...
<p&gtThe flush-mounted CONNECT radio receiver, 1-gang universal dimmer, will be referred to below as "dimmer".</p&gt <p&gtThe dimmer is used to switch and dim luminaires (see technical data) via radio signal and via an extension push-button connected directly to the dimmer.</p&gt <p&gtThe dimmer automatically recognises the connected load, is overload-proof, short-circuit-proof and hum-free, and has a soft start function which slowly dims up a connected load.</p&gt

### Inclusion Information

<p&gtTeaching (transmits Node info frame), see CONNECT radio system description</p&gt

### Exclusion Information

<p&gtReset to the factory settings; de- lete everything taught</p&gt
