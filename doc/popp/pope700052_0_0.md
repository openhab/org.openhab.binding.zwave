...
<p&gtTo wakeup the device please perform the following action: Double click the internal Button. The red LED will light up to confirm the action.</p&gt
