...
<p&gtIf not zero, automatically switch device off after a user defined time.</p&gt <ul&gt<li&gt0 -> Disabled</li&gt <li&gt1 - 65535 -> Enabled, automatically switch off after x seconds.</li&gt </ul&gt
...
<p&gtSpecify the consumption of the load in watts, for the calculation of power consumption:</p&gt <ul&gt<li&gt0 -> Disabled</li&gt <li&gt1 - 3500 -> Watts</li&gt </ul&gt
