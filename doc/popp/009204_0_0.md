...
<p&gtEnter management mode  by push all four buttons together for one second - green led blinks slowly), then hit button 2 .</p&gt
...
<p&gtIf the KFOB wakes up and there is no controller nearby, several unsuccessful communication attempts will drain battery.</p&gt
The following option values may be configured -:
...
<p&gtIf the KFOB wakes up and there is no controller nearby, several unsuccessful communication attempts will drain battery. Value</p&gt
The following option values may be configured -:
...
<p&gtcontrolled by button 1 or single clicks of buttons 1 and 3 </p&gt

Association group 2 supports 10 nodes.

### Group 3: Control Group B

<p&gt controlled by button 2 or single clicks of buttons 2 and 4 </p&gt

Association group 3 supports 10 nodes.

### Group 4: Control Group C

<p&gt controlled by button 3 or double clicks of buttons 1 and 3</p&gt

Association group 4 supports 10 nodes.

### Group 5: Control Group D

<p&gtcontrolled by button 4 or double clicks of buttons 2 and 4</p&gt
