...
<p&gtThe Door/Window Detector is a Z-Wave<sup&gtTM</sup&gt enabled device and is fully compatible with any Z-Wave<sup&gtTM</sup&gt enabled network. Z-Wave<sup&gtTM</sup&gt enabled devices displaying the Z-Wave<sup&gtTM</sup&gt logo can also be used with it regardless of the manufacturer, and ours can also be used in other manufacturer’s Z-Wave<sup&gtTM</sup&gt enabled networks.  Inclusion of this Door/Window Detector on other manufacturer’s Wireless Controller menu allows remote turn-on of connected modules and their connected lighting when the Detector is triggered.</p&gt
...
<p&gtPress tamper switch three times within 1.5 seconds will prolong its awake period to 10 minutes</p&gt
