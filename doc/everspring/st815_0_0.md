...
<p&gtThe Illumination Sensor is designed to monitor the current illumination of ambient environment. The reading of illumination can be reported to you on a regular base at your disposal. If illumination reaches set points, the sensor will send alerts to associated devices for further execution (such as trigger on connected lightings). The Illumination Sensor is suitable for use in darkness and outdoor. </p&gt

### Inclusion Information

<p&gtPressing ESC key 3 times within 1.5 seconds will enter inclusion mode. </p&gt

### Exclusion Information

<p&gtPressing ESC key 3 times within 1.5 seconds will enter exclusion mode. </p&gt
...
Basic Set Level
<p&gtSet basic set value to be on or off.</p&gt <p&gtSet to 0 to disable</p&gt
...
<p&gtLux level when ON command is sent out.</p&gt <p&gtSet to 0 to disable.</p&gt <p&gtValid values - 30-1000 or 0</p&gt <p&gtDefault 30</p&gt
...
<p&gtLux level when Off command is sent out.</p&gt <p&gtValues 30-1000 or 0</p&gt <p&gtDefault 500</p&gt <p&gtSet to 0 to disable.</p&gt
Values in the range 0 to 1000 may be set.
...
<p&gtTimer value in minutes.</p&gt <p&gtValues : 1-480 or 0</p&gt <p&gtDefault 240</p&gt <p&gtSet to 0 to disable.</p&gt
...
<p&gtTime interval in minutes to auto report to association group 1</p&gt <p&gtValid values 1-1439 minutes or 0</p&gt <p&gtSet to 0 to Disable</p&gt
...
<p&gtLux interval step size to auto report to association group 1</p&gt <p&gtValid Values 30-1000 (Lux)</p&gt <p&gtSet to 0 to Disable</p&gt
Values in the range 0 to 1000 may be set.
