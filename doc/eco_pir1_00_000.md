...
# Ecolink PIR Z-Wave PIR Motion Sensor

This describes the Z-Wave device **Ecolink PIR**, manufactured by **Ecolink** with the thing type UID of ```eco_pir1_00_000```. 
...
## Channels
The following table summarises the channels available for the Ecolink PIR Z-Wave PIR Motion Sensor.
...
The following table provides a summary of the configuration parameters available in the Ecolink PIR Z-Wave PIR Motion Sensor.
