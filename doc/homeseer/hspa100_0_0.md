...
<p&gtThe connected lighting devices can be controlled manually with a push button, your smartphone or a Home Automation system such as HomeSeer. Depending on the capability of your controller/gateway, once the Plug-in Module has been added to your network, you may assign it to a Group or Scene and change its status via your controller/gateway</p&gt

### Inclusion Information

<p&gtPress the button on the front</p&gt

### Exclusion Information

<p&gtPower the module off and then back on</p&gt
