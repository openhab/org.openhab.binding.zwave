...
<p&gtHS-WS100+ is a Z-Wave wall switch that’s designed for wireless on-off control of connected lighting and appliance loads. </p&gt
...
<p&gtDefines the behavior of the indicator LED.  Default is Night Light mode where LED is on when switch is off.</p&gt
