...
<p&gtHS-WD100+ is a Z-Wave wall dimmer that’s designed for wireless on-off-dim control of connected dimmable lighting loads. </p&gt

### Inclusion Information

<p&gtTap the paddle of your new HomeSeer switch to begin the inclusion process. This will take a few moments to complete. </p&gt

### Exclusion Information

<p&gtSingle click and release the rocker switch. </p&gt
...
<p&gtThis is the step value that the dimmer level is incremented or decremented for each step duration when controlled remotely.</p&gt <p&gt(This parameter was added in firmware version 5.14)</p&gt
...
<p&gtSelect time interval to move to the next brightness level. The larger the number, the slower the adjustment to dim levels. </p&gt <p&gt(This parameter was added in firmware version 5.14)</p&gt
...
<p&gtThis is the step value that the dimmer level is incremented or decremented for each step duration when controlled locally.</p&gt
Values in the range 1 to 99 may be set.
...
<p&gtSelect time interval to move to the next brightness level. The larger the number, the slower the adjustment to dim levels. </p&gt
Values in the range 1 to 255 may be set.
