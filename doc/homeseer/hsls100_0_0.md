...
<p&gtHomeseer HS-LS100+ is a compact, easy to install leak sensor. It designed control other ZLS100+ is a compact, easy to install leak sensor. It designed control other Z-Wave devices directly or it may be used with a variety of Z-Wave certified home controllers to launch automation events or scenes.</p&gt

### Inclusion Information

<p&gtInclusion (recommended if your home controller supports “S0” or “S2” Z-Wave encryption)<br /&gt1. Put your home controller into Z-Wave ‘inclusion’ mode.<br /&gt2. Quickly triple-press the Z-Wave network button, then release it. Wait for the inclusion process to finish.</p&gt

### Exclusion Information

<p&gtExclusion<br /&gt1. Put your home automation controller into Z-Wave ‘exclusion’ mode.<br /&gt2. Quickly triple-press the Z-Wave network button. Wait for the exclusion process to finish.</p&gt
...
<p&gtPress and hold the Z button for more that 5 seconds and release</p&gt
...
<p&gtThe higher the value, the long the report periodically - in hexadecimal values from 0x01 to 0xFF, or 1 to 255 if your controller allows unsigned decimal values.</p&gt <p&gt0 - Disable flooding alarm</p&gt
...
<p&gtThe higher the value ,the long the report time</p&gt <p&gt0 - Disable report</p&gt
Values in the range 0 to 255 may be set.
...
<p&gtThe larger the value , the higher the high temperature in Fahrenheits (US)</p&gt
...
<p&gtThe smaller the value , the lower the low temperature in Fahrenheits (US)</p&gt
Values in the range -670 to 2570 may be set.
...
<p&gtSet the trigger value for the low battery alarm</p&gt
...
<p&gt1. Notification Report. Sensor will send Notification Report to the associated nodes</p&gt <p&gt2. Battery Report. Sensor will send Battery Report when the battery level is low and the battery report’s value is 0xFF.</p&gt <p&gt3. Device Reset Locally Notification. Sensor will send Device Reset Locally Notification when reset</p&gt <p&gt4.Sensor multilevel report When associated to Group 1, you can adjust the temperature reporting cycle according to the configuration settings.</p&gt

Association group 1 supports 5 nodes.

### Group 2: Control

<p&gt1. Basic Set. Flood Sensor will send Basic Set to associated nodes when Water leak detected.</p&gt
