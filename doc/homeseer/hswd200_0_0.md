...
<p&gtLED 7 is the top LED</p&gt <p&gtPossible values: 0-7</p&gt <p&gt0=Off, 1=Red, 2=Green, 3=Blue, 4=Magenta, 5=Yellow, 6=Cyan, 7=White</p&gt
...
<p&gtSets the dimmer Blink frequency for All LEDs in Status mode </p&gt <p&gtPossible values: 0, 1-255</p&gt <p&gt0=No blink, 1=100ms ON then 100ms OFF</p&gt
