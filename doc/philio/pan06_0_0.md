...
<p&gtThe PAN06 allows controlling two independent loads both wirelessly via Z-Wave and locally utilizing a traditional wall switch. Thanks to its calibration technology the device cannot only be used to switch resistive devices but also works perfectly with many kind of reactive or resistive loads such as fluorescent lights or LEDs.<br /&gtThe device is placed in a wall box right behind the normal switch. The switch is not longer directly<br /&gtconnected to the load but acts as input device for the insert that is controlling the load. This device is<br /&gtdesigned for a 3 wire system and needs a neutral wire in the wall box.</p&gt

### Inclusion Information

<p&gt1. Have Z-Wave Controller entered inclusion mode<br /&gt2. Pressing Include button of PAN06 three times within 1.5 seconds will enter inclusion mode.</p&gt

### Exclusion Information

<p&gt1. Have Z-Wave Controller entered exclusion mode<br /&gt2. Pressing Include button of PAN06 three times within 1.5 seconds will enter exclusion mode.</p&gt
