...
<p&gtThe flood multisensor PAT02 has flood sensor, based on Z-WaveTM technology.</p&gt
...
<ul&gt<li&gtSetting the BASIC command value <ul&gt<li&gtWhen the flood trigger off(0x00), send the BASIC CC to the group 2.</li&gt </ul&gt</li&gt </ul&gt
...
Setting the BASIC command value
<ul&gt<li&gtSetting the BASIC command value <ul&gt<li&gtWhen the flood trigger on(0xFF), send the BASIC CC to the group 2.  </li&gt </ul&gt</li&gt </ul&gt
Values in the range 0 to 255 may be set.
...
<p&gtOperation mode. Using bit to control.</p&gt <ul&gt<li&gtBit0: Disable the Flood function.</li&gt <li&gtBit1: Reserve.</li&gt <li&gtBit2: Reserve.</li&gt <li&gtBit3: not applicable for this device variant, set to 0</li&gt <li&gtBit4: Reserve.</li&gt <li&gtBit5: not applicable for this device variant, set to 1</li&gt <li&gtBit6: Reserve.</li&gt <li&gtBit7: Reserve.</li&gt </ul&gt
...
<p&gtThe interval time for auto report the battery level.</p&gt <p&gt0 means turn off auto report. The default value is 12. The tick time can setting by the configuration No.20.</p&gt
...
<p&gtThe interval time for auto report the flood state.</p&gt <p&gt0 means turn off auto report. The default value is 12. The tick time can setting by the configuration No.20.</p&gt
Values in the range 0 to 127 may be set.
...
<p&gtThe interval time for auto report each tick.</p&gt <p&gtSetting this configuration will effect configuration No.10, No.13, No.14 and No.15.</p&gt <p&gtUnits of one minute.</p&gt <p&gtCaution1: Setting to 0 means turn off all auto report function.</p&gt <p&gtCaution2: The value is unsigned byte</p&gt
Values in the range 0 to 255 may be set.
