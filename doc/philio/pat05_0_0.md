...
<p&gtThe PAT05 multi-sensor is a device that allows you to check the air quality in your home, as well as detect temperature and humidity.</p&gt <p&gtThe PAT05 Multi-sensor is easy to use and very convenient for your home. Just set the sensor on the wall of the rooms you would like to control, and you are ready to go.</p&gt

### Inclusion Information

<p&gt1. Have Z-WaveTM Controller entered inclusion mode.</p&gt <p&gt2. Pressing tamper key three times within 2 seconds to enter the inclusion mode.</p&gt <p&gt3. After add successful, the device will wake to receive the setting command from Z-WaveTM Controller about 20 seconds.</p&gt

### Exclusion Information

<p&gt1. Have Z-WaveTM Controller entered exclusion mode.</p&gt <p&gt2. Pressing tamper key three times within 2 seconds to enter the exclusion mode.</p&gt <p&gtNode ID has been excluded.</p&gt
...
<p&gtThe Unit is 100ppm.</p&gt <p&gt0 means turn off eCO2 detected function.</p&gt
...
<p&gtThe Unit is 100ppb.</p&gt <p&gt0 means turn off TVOC detected function.</p&gt
Values in the range 0 to 100 may be set.
...
<p&gt0 means turn off auto report eCO2.</p&gt <p&gtThe default value is 1.</p&gt <p&gtThe tick time can setting by the configuration No.16</p&gt  
...
<p&gt0 means turn off auto report TVOC.</p&gt <p&gtThe default value is 1.</p&gt <p&gtThe tick time can setting by the configuration No.16.</p&gt  
Values in the range 0 to 127 may be set.
...
<p&gtSetting this configuration will effect configuration No.14 and No.15.</p&gt <p&gtThe unit is 1 minute.</p&gt <p&gtCaution1: Setting to 0 means turn off all auto report function. <br /&gtCaution2: The value is unsigned byte, the range is from 0x00 ~ 0xFF.</p&gt
...
<p&gt0 means turn off this function.</p&gt <p&gtThe unit is percentage.<br /&gtEnable this function the device will detect every percentage.<br /&gtAnd when the CO2 Sensor is over 10 percentage, it will continue report.</p&gt
Values in the range 0 to 100 may be set.
...
<p&gt0 means turn off this function.</p&gt <p&gtThe unit is percentage.</p&gt <p&gtEnable this function the device will detect every percentage.</p&gt <p&gtAnd when the TVOC Sensor is over 10 percentage, it will continue report.</p&gt
Values in the range 0 to 100 may be set.
