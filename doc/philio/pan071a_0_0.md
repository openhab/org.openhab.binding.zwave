...
<p&gtPressing INCLUDE_BUTTON three times within 2 seconds will enter inclusion mode.</p&gt

### Exclusion Information

<p&gtPressing INCLUDE_BUTTON three times within 2 seconds will enter exclusion mode. </p&gt
...
<h1&gt 5 second units</h1&gt <p&gtDefault: 720\*5s=3600s=1 hour</p&gt <p&gtIf the setting is configured for 1hour (set value =720), the PAN07/PAN09 will report its instant power consumption every 1 hour to the node of correspond Group. The maximum interval to report its instant power consumption is 45 hours (5s\*32767/3600=45hr). </p&gt
...
KWH Meter Report
<h1&gt10 minute units</h1&gt <p&gtdefault: 6\*10min= 1 hour</p&gt <p&gtIf the setting is configured for 1hour (set value =6), the PAN07/PAN09 will report its Accumulated Power Consumption (KW/h) every 1 hour to the node of correspond Group. The maximum interval to report its Accumulated Power Consumption (KW/h) is 227.55 days (10min\*32767/1440=227.55 days)</p&gt
Values in the range 1 to 32767 may be set.
...
Selected Relay
<p&gtIf Controller not using Multi_Channel command class to access the relay of PAN07/PAN09, you may configure the value of relay to react the Basic Command Class 、Binary Switch Command Class or Meter Command Class V3 </p&gt
...
<p&gtThe endpoint3 of Multi-Channel Command Class is related to relay1 and relay2. It may be redundant for the need to control relay1 or relay2 individually. When the Existence of Endpoint3 is set as 0, the endpoint3 of Multi-Channel Command Class will be disabled. The default value is 1</p&gt
The following option values may be configured -:
...
<p&gtFor group 1, the Switch will report (1) ON/OFF status of Relay1 and Relay2 (2) Instant Power Consumption (Watt) of Relay1 and Relay2 (3) Accumulated Power Consumption (KWh) of Relay1 and Relay2 to Z-Wave Controller.  </p&gt

Association group 1 supports 1 node.

### Group 2: Group 2

<p&gtFor group 2, the Switch will report (1) ON/OFF status of Relay1 (2) Instant Power Consumption (Watt) of Relay1 (3) Accumulated Power Consumption (KWh) of Relay1 to Z-Wave Controller. </p&gt

Association group 2 supports 1 node.

### Group 3: Group 3

<p&gtFor group 3, the Switch will report (1) ON/OFF status of Relay2 (2) Instant Power Consumption (Watt) of Relay2 (3) Accumulated Power Consumption (KWh) of Relay2 to Z-Wave Controller. </p&gt
