...
<p&gtPress test button three times within 1.5 seconds to enter the inclusion mode.</p&gt

### Exclusion Information

<p&gtPressing test button three times within 1.5 seconds to enter the exclusion mode.</p&gt
...
<p&gtIf you want to wake-up device immediately, please press the button once. The device will wake-up for 10 seconds.</p&gt
