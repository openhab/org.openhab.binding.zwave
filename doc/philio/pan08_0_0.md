...
<p&gtThe in-wall MicroModule Motor Controller is designed to switch rise/lower roller shutter connected to its terminals using radio waves, controllers and a push button directly connected to this Roller Controller</p&gt

### Inclusion Information

<p&gtPressing Include button three times within 2 seconds will enter inclusion mode.</p&gt

### Exclusion Information

<p&gtPressing Include button three times within 2 seconds will enter exclusion mode.</p&gt
