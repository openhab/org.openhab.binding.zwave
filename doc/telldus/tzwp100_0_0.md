...
<p&gtPlug­in switch, controls lighting and other electronic equipment up to 2000 W (resistive load). </p&gt

### Inclusion Information

<p&gtPress the button on the device three times fast.</p&gt
...
<p&gtThe plug will send it's status to the node in this group whenever the status of the plug changes.<br /&gtLifeline is normally used to send the plug status to the main controller / gateway.</p&gt

Association group 1 supports 1 node.

### Group 2: Control other devices

<p&gtThe plug will send Basic Set control signals to the nodes in this group whenever the status of the<br /&gtplug changes. This will work like a master/slave solution.</p&gt
