...
<p&gtFEATURES</p&gt <ul&gt<li&gtWorks with incandescent, florescent (CFL), or LED lighting and appliance</li&gt <li&gtON/OFF status and location LED indicator</li&gt <li&gtCan be controlled wirelessly or manually</li&gt <li&gtFits into standard single or multiple gang junction box and standard wall plates</li&gt <li&gtDecorative keypad can be replaced manually to match color with other wall switches</li&gt <li&gtOver-­‐The-­‐Air firmware upgrade available with compatible gateway, Z-­‐Wave® static controller, PC and software</li&gt <li&gtZ-­‐Wave 500 Series module inside</li&gt <li&gtInternal resettable fuse to protect from surge current</li&gt <li&gtmanual reset capability</li&gt </ul&gt
