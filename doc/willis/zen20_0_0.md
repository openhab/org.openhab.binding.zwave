...
<ul&gt<li&gtWireless control of up to 5 electrical devices</li&gt <li&gtScene inclusion for custom automation scenarios when included to a Z-Wave gateway controller</li&gt <li&gtZ-Wave Plus with improved 500 chip for faster and safer wireless communication\</li&gt <li&gtSignal repeater for a stronger, more reliable network</li&gt <li&gt2 USB charging ports for your smart phone or tablet (no Z-Wave functionality)</li&gt <li&gtBuilt-in overload protection</li&gt </ul&gt

### Inclusion Information

<ol&gt<li&gtPlug the power strip into a grounded receptacle located within direct range from your Z- Wave gateway controller</li&gt <li&gtPut your Z-Wave controller in inclusion mode</li&gt <li&gtPress and release the CH1 power button on the strip 3 times quickly</li&gt <li&gtA new on / off device should appear on your controller's device list</li&gt </ol&gt<h1&gtTroubleshooting Tips</h1&gt <p&gtIf you are unable to include the Z-Wave power strip to your controller, please try one of the following:</p&gt <ul&gt<li&gtBring the power strip closer to your Z-Wave controller</li&gt <li&gtPress and release the CH1 power button quickly 7-8 times once you put the controller in the inclusion mode to ensure the command has gone through</li&gt <li&gtPut your controller in the EXCLUSION mode and press and release the CH1 power button quickly 3 times, then try adding it to your network again</li&gt </ul&gt

### Exclusion Information

<ol&gt<li&gtPlug the power strip into a grounded receptacle located within direct range from your Z-Wave gateway controller</li&gt <li&gtPut your Z-Wave controller in exclusion mode</li&gt <li&gtPress and release the CH1 power button on the strip 3 times quickly</li&gt <li&gtThe device should disappear from your controller's device list</li&gt </ol&gt<p&gtPlease repeat the process following all steps carefully if the first attempt is unsuccessful</p&gt
