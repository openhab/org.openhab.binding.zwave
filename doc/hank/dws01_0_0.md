...
<p&gtSensor detects when a door is open or closed, also has a tamper switch.</p&gt

### Inclusion Information

<p&gtNon-secure: press the Z-button three times rapidly.</p&gt <p&gtSecure: hold the Z-button for three seconds.</p&gt

### Exclusion Information

<p&gtPress the Z-button three times rapidly.</p&gt
...
<p&gtSeparate the magnet from the sensor body or pull the cover back and press the little button near the tamper switch until the little blue LED illuminates.</p&gt

### General Usage Information

<p&gtUnit is labeled with HKZW-DWS01, but also sold as "MONOPRICE Door and Window Sensor P/N 24259"</p&gt
...
Association Group 1
<ul&gt<li&gt <p&gtGroup 1 reports the status of the Door/Window Sensor, the battery level, and the tamper button status. </p&gt </li&gt </ul&gt
...
Association Group 2
<ul&gt<li&gt <p&gtGroup 2 is assigned to the Door/Window Sensor BASIC SET command. </p&gt </li&gt </ul&gt
