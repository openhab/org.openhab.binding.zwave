...
<p&gtSiren 6 is your home’s smart indoor siren.</p&gt <p&gtBuilt with Z-Wave Plus S2 to be a smart home security siren, it features a 110dB speaker coupled with 1,000 lumens visual light alert strobe. Can be used as siren for security alarm, smoke sensor, and CO sensors via Z-Wave</p&gt

### Inclusion Information

<p&gtClick Chime Action Button once, it will quickly flash white light for 30 seconds until Chime is added into the network.</p&gt <p&gtIt will become constantly bright white light after being assigned a NodeID.</p&gt

### Exclusion Information

<p&gtClick Chime Action Button 6 times quickly; it will bright white light, up to 2s.</p&gt <p&gtIf Removing succeeds, it will quickly flash white light 3 times and then become breathing white light. Now, Chime is removed from Z-Wave network successfully.</p&gt

### General Usage Information

<p&gtYou’re able to test Siren 6’s speaker system manually.</p&gt <p&gt<strong&gtSafety</strong&gt: test only when wearing necessary ear protection. Siren 6’s speaker emits tones up to 105dB that can cause hearing damage.</p&gt <p&gtTo test manually, press and hold Action Button for 2 to 5 seconds.</p&gt
...
<table&gt<tr&gt<td&gt<strong&gtValue</strong&gt</td&gt <td&gt<strong&gtDescription</strong&gt</td&gt </tr&gt<tr&gt<td&gt0</td&gt <td&gtUnlimited playback until stop by user.</td&gt </tr&gt<tr&gt<td&gt1 ..254</td&gt <td&gt1-254 times. Specify the count that the tone will be repeated to be played.</td&gt </tr&gt<tr&gt<td&gt255</td&gt <td&gtUse the last valid configuration value.</td&gt </tr&gt</table&gt
...
<h1&gtInterval between 2 tones for Endpoint 2 (Tampering)</h1&gt <table&gt<tr&gt<td&gt<strong&gtValue</strong&gt</td&gt <td&gt<strong&gtDescription</strong&gt</td&gt </tr&gt<tr&gt<td&gt0</td&gt <td&gtNo interval.</td&gt </tr&gt<tr&gt<td&gt1 .. 254</td&gt <td&gt1-254 seconds. Specify the interval time between 2 tones .</td&gt </tr&gt<tr&gt<td&gt255</td&gt <td&gtUse the last valid configuration value.</td&gt </tr&gt</table&gt
The following option values may be configured, in addition to values in the range 0 to 255 -:
...
<h1&gtIntercepting duration of a tone for Endpoint 2 (Tampering)</h1&gt <table&gt<tr&gt<td&gt<strong&gtValue</strong&gt</td&gt <td&gt<strong&gtDescription</strong&gt</td&gt </tr&gt<tr&gt<td&gt0</td&gt <td&gtKeep the original duration of a tone itself, without any interception .</td&gt </tr&gt<tr&gt<td&gt1 .. 254</td&gt <td&gt1-254 seconds. Intercept the duration of a tone . If the intercepting duration is <strong&gtshorter</strong&gt than the original duration of a tone, actual single play time is equal to the intercepting duration. If the intercepting duration is<strong&gt longer</strong&gt than the original duration of a tone, actual single play time is equal to the original duration</td&gt </tr&gt<tr&gt<td&gt255</td&gt <td&gtUse the last valid configuration value.</td&gt </tr&gt</table&gt<p&gt.</p&gt
The following option values may be configured, in addition to values in the range 0 to 255 -:
...
<p&gtLight Effect Index for Endpoint 2 (Tampering)</p&gt
The following option values may be configured -:
...
<h1&gtTone Play Count for Endpoint 3 (Doorbell 1)</h1&gt <table&gt<tr&gt<td&gt<strong&gtValue</strong&gt</td&gt <td&gt<strong&gtDescription</strong&gt</td&gt </tr&gt<tr&gt<td&gt0</td&gt <td&gtUnlimited playback until stop by user.</td&gt </tr&gt<tr&gt<td&gt1 .. 254</td&gt <td&gt1-254 times. Specify the count that the tone will be repeated to be played.</td&gt </tr&gt<tr&gt<td&gt255</td&gt <td&gtUse the last valid configuration value.</td&gt </tr&gt</table&gt
The following option values may be configured, in addition to values in the range 0 to 255 -:
...
<h1&gtInterval between 2 tones for Endpoint 3 (Doorbell 1)</h1&gt <table&gt<tr&gt<td&gt<strong&gtValue</strong&gt</td&gt <td&gt<strong&gtDescription</strong&gt</td&gt </tr&gt<tr&gt<td&gt0</td&gt <td&gtNo interval.</td&gt </tr&gt<tr&gt<td&gt1 .. 254</td&gt <td&gt1-254 seconds. Specify the interval time between 2 tones .</td&gt </tr&gt<tr&gt<td&gt255</td&gt <td&gtUse the last valid configuration value.</td&gt </tr&gt</table&gt
The following option values may be configured, in addition to values in the range 0 to 255 -:
...
<h1&gtIntercepting duration of a tone for Endpoint 3(Doorbell 1)</h1&gt <table&gt<tr&gt<td&gt<strong&gtValue</strong&gt</td&gt <td&gt<strong&gtDescription</strong&gt</td&gt </tr&gt<tr&gt<td&gt0</td&gt <td&gtKeep the original duration of a tone itself, without any interception.</td&gt </tr&gt<tr&gt<td&gt1 .. 254</td&gt <td&gt1-254 seconds. Intercept the duration of a tone . If the intercepting duration is <strong&gtshorter</strong&gt than the original duration of a tone, actual single play time is equal to the intercepting duration. If the intercepting duration is <strong&gtlonger</strong&gt than the original duration of a tone, actual single play time is equal to the original duration.</td&gt </tr&gt<tr&gt<td&gt255</td&gt <td&gtUse the last valid configuration value.</td&gt </tr&gt</table&gt
...
<h1&gtTone Play Count for Endpoint 4 (Doorbell 2)</h1&gt <table&gt<tr&gt<td&gt<strong&gtValue</strong&gt</td&gt <td&gt<strong&gtDescription</strong&gt</td&gt </tr&gt<tr&gt<td&gt0</td&gt <td&gtUnlimited playback until stop by user.</td&gt </tr&gt<tr&gt<td&gt1 .. 254</td&gt <td&gt1-254 times. Specify the count that the tone will be repeated to be played.</td&gt </tr&gt<tr&gt<td&gt255</td&gt <td&gtUse the last valid configuration value.</td&gt </tr&gt</table&gt
The following option values may be configured, in addition to values in the range 0 to 255 -:
...
<h1&gtInterval between 2 tones for Endpoint 4 (Doorbell 2)</h1&gt <table&gt<tr&gt<td&gt<strong&gtValue</strong&gt</td&gt <td&gt<strong&gtDescription</strong&gt</td&gt </tr&gt<tr&gt<td&gt0</td&gt <td&gtNo interval.</td&gt </tr&gt<tr&gt<td&gt1 .. 254</td&gt <td&gt1-254 seconds. Specify the interval time between 2 tones .</td&gt </tr&gt<tr&gt<td&gt255</td&gt <td&gtUse the last valid configuration value.</td&gt </tr&gt</table&gt
The following option values may be configured, in addition to values in the range 0 to 255 -:
...
<h1&gtIntercepting Duration of a tone for Endpoint 4 (Doorbell 2)</h1&gt <table&gt<tr&gt<td&gt<strong&gtValue</strong&gt</td&gt <td&gt<strong&gtDescription</strong&gt</td&gt </tr&gt<tr&gt<td&gt0</td&gt <td&gtKeep the original duration of a tone itself, without any interception.</td&gt </tr&gt<tr&gt<td&gt1 .. 254</td&gt <td&gt1-254 seconds. Intercept the duration of a tone . If the intercepting duration is <strong&gtshorter</strong&gt than the original duration of a tone, actual single play time is equal to the intercepting duration. If the intercepting duration is <strong&gtlonger</strong&gt than the original duration of a tone, actual single play time is equal to the original duration.</td&gt </tr&gt<tr&gt<td&gt255</td&gt <td&gtUse the last valid configuration value.</td&gt </tr&gt</table&gt
The following option values may be configured, in addition to values in the range 0 to 255 -:
...
<p&gtLight Effect Index for Endpoint 4 (Doorbell 2)</p&gt
The following option values may be configured -:
...
<h1&gtTone Play Count for Endpoint 5 (Doorbell 3)</h1&gt <table&gt<tr&gt<td&gt<strong&gtValue</strong&gt</td&gt <td&gt<strong&gtDescription</strong&gt</td&gt </tr&gt<tr&gt<td&gt0</td&gt <td&gtUnlimited playback until stop by user.</td&gt </tr&gt<tr&gt<td&gt1 .. 254</td&gt <td&gt1-254 times. Specify the count that the tone will be repeated to be played.</td&gt </tr&gt<tr&gt<td&gt255</td&gt <td&gtUse the last valid configuration value.</td&gt </tr&gt</table&gt
The following option values may be configured, in addition to values in the range 0 to 255 -:
...
<h1&gtInterval between 2 tones for Endpoint 5 (Doorbell 3)</h1&gt <table&gt<tr&gt<td&gt<strong&gtValue</strong&gt</td&gt <td&gt<strong&gtDescription</strong&gt</td&gt </tr&gt<tr&gt<td&gt0</td&gt <td&gtNo interval.</td&gt </tr&gt<tr&gt<td&gt1 .. 254</td&gt <td&gt1-254 seconds. Specify the interval time between 2 tones .</td&gt </tr&gt<tr&gt<td&gt255</td&gt <td&gtUse the last valid configuration value.</td&gt </tr&gt</table&gt
The following option values may be configured, in addition to values in the range 0 to 255 -:
...
<h1&gtIntercepting duration of a tone for Endpoint 5(Doorbell 3) .</h1&gt <table&gt<tr&gt<td&gt<strong&gtValue</strong&gt</td&gt <td&gt<strong&gtDescription</strong&gt</td&gt </tr&gt<tr&gt<td&gt0</td&gt <td&gtKeep the original duration of a tone itself, without any interception.</td&gt </tr&gt<tr&gt<td&gt1 .. 254</td&gt <td&gt1-254 seconds. Intercept the duration of a tone . If the intercepting duration is <strong&gtshorter</strong&gt than the original duration of a tone, actual single play time is equal to the intercepting duration. If the intercepting duration is <strong&gtlonger</strong&gt than the original duration of a tone, actual single play time is equal to the original duration.</td&gt </tr&gt<tr&gt<td&gt255</td&gt <td&gtUse the last valid configuration value.</td&gt </tr&gt</table&gt
The following option values may be configured, in addition to values in the range 0 to 255 -:
...
<p&gtLight Effect Index for Endpoint 5 (Doorbell 3) .</p&gt
The following option values may be configured -:
...
<p&gtTone Play Count for Endpoint 6 (Environment)</p&gt
The following option values may be configured, in addition to values in the range 0 to 255 -:
...
<h1&gtInterval between 2 tones for Endpoint 6 (Environment)</h1&gt <table&gt<tr&gt<td&gt<strong&gtValue</strong&gt</td&gt <td&gt<strong&gtDescription</strong&gt</td&gt </tr&gt<tr&gt<td&gt0</td&gt <td&gtNo interval.</td&gt </tr&gt<tr&gt<td&gt1 .. 254</td&gt <td&gt1-254 seconds. Specify the interval time between 2 tones.</td&gt </tr&gt<tr&gt<td&gt255</td&gt <td&gtUse the last valid configuration value.</td&gt </tr&gt</table&gt
The following option values may be configured, in addition to values in the range 0 to 255 -:
...
<h1&gtDuration of a tone for Endpoint 6 (Environment)</h1&gt <table&gt<tr&gt<td&gt<strong&gtValue</strong&gt</td&gt <td&gt<strong&gtDescription</strong&gt</td&gt </tr&gt<tr&gt<td&gt0</td&gt <td&gtKeep the original duration of a tone itself, without any interception.</td&gt </tr&gt<tr&gt<td&gt1 .. 254</td&gt <td&gt1-254 seconds. Intercept the duration of a tone. If the intercepting duration is <strong&gtshorter</strong&gt than the original duration of a tone, actual single play time is equal to the intercepting duration. If the intercepting duration is<strong&gt longer</strong&gt than the original duration of a tone, actual single play time is equal to the original duration.</td&gt </tr&gt<tr&gt<td&gt255</td&gt <td&gtUse the last valid configuration value.</td&gt </tr&gt</table&gt
The following option values may be configured, in addition to values in the range 0 to 255 -:
...
<p&gtLight Effect for Endpoint 6 (Environment)</p&gt
The following option values may be configured -:
...
<h1&gtTone play count for Endpoint 7 (Security)</h1&gt <table&gt<tr&gt<td&gt<strong&gtValue</strong&gt</td&gt <td&gt<strong&gtDescription</strong&gt</td&gt </tr&gt<tr&gt<td&gt0</td&gt <td&gtUnlimited playback until stop by user.</td&gt </tr&gt<tr&gt<td&gt1 .. 254</td&gt <td&gt1-254 times. Specify the count that the tone will be repeated to be played.</td&gt </tr&gt<tr&gt<td&gt255</td&gt <td&gtUse the last valid configuration value.</td&gt </tr&gt</table&gt
The following option values may be configured, in addition to values in the range 0 to 255 -:
...
<h1&gtInterval between 2 tones for Endpoint 7 (Security)</h1&gt <table&gt<tr&gt<td&gt<strong&gtValue</strong&gt</td&gt <td&gt<strong&gtDescription</strong&gt</td&gt </tr&gt<tr&gt<td&gt0</td&gt <td&gtNo interval.</td&gt </tr&gt<tr&gt<td&gt1 .. 254</td&gt <td&gt1-254 seconds. Specify the interval time between 2 tones .</td&gt </tr&gt<tr&gt<td&gt255</td&gt <td&gtUse the last valid configuration value.</td&gt </tr&gt</table&gt
The following option values may be configured, in addition to values in the range 0 to 255 -:
...
<h1&gtIntercepting duration of a tone for Endpoint 7 (Security)</h1&gt <table&gt<tr&gt<td&gt<strong&gtValue</strong&gt</td&gt <td&gt<strong&gtDescription</strong&gt</td&gt </tr&gt<tr&gt<td&gt0</td&gt <td&gtKeep the original duration of a tone itself, without any interception.</td&gt </tr&gt<tr&gt<td&gt1 .. 254</td&gt <td&gt1-254 seconds. Intercept the duration of a tone . If the intercepting duration is <strong&gtshorter</strong&gt than the original duration of a tone, actual single play time is equal to the intercepting duration. If the intercepting duration is <strong&gtlonger</strong&gt than the original duration of a tone, actual single play time is equal to the original duration.</td&gt </tr&gt<tr&gt<td&gt255</td&gt <td&gtUse the last valid configuration value.</td&gt </tr&gt</table&gt
The following option values may be configured, in addition to values in the range 0 to 255 -:
...
<p&gtLight Effect Index for Endpoint 7 (Security)</p&gt
The following option values may be configured -:
...
<h1&gtTone Play Count for Endpoint 8 (Emergency)</h1&gt <table&gt<tr&gt<td&gt<strong&gtValue</strong&gt</td&gt <td&gt<strong&gtDescription</strong&gt</td&gt </tr&gt<tr&gt<td&gt0</td&gt <td&gtUnlimited playback until stop by user.</td&gt </tr&gt<tr&gt<td&gt1 .. 254</td&gt <td&gt1-254 times. Specify the count that the tone will be repeated to be played.</td&gt </tr&gt<tr&gt<td&gt255</td&gt <td&gtUse the last valid configuration value.</td&gt </tr&gt</table&gt
The following option values may be configured, in addition to values in the range 0 to 255 -:
...
<h1&gtInterval between 2 tones for Endpoint 8 (Emergency)</h1&gt <table&gt<tr&gt<td&gt<strong&gtValue</strong&gt</td&gt <td&gt<strong&gtDescription</strong&gt</td&gt </tr&gt<tr&gt<td&gt0</td&gt <td&gtNo interval.</td&gt </tr&gt<tr&gt<td&gt1 .. 254</td&gt <td&gt1-254 seconds. Specify the interval time between 2 tones .</td&gt </tr&gt<tr&gt<td&gt255</td&gt <td&gtUse the last valid configuration value.</td&gt </tr&gt</table&gt
The following option values may be configured, in addition to values in the range 0 to 255 -:
...
<h1&gtIntercepting duration of a tone for Endpoint 8 (Emergency)</h1&gt <table&gt<tr&gt<td&gt<strong&gtValue</strong&gt</td&gt <td&gt<strong&gtDescription</strong&gt</td&gt </tr&gt<tr&gt<td&gt0</td&gt <td&gtKeep the original duration of a tone itself, without any interception.</td&gt </tr&gt<tr&gt<td&gt1 .. 254</td&gt <td&gt <p&gt1-254 seconds. Intercept the duration of a tone . If the intercepting duration is <strong&gtshorter</strong&gt than the original duration of a tone, actual single play time is equal to the intercepting duration. If the intercepting duration is<strong&gt longer</strong&gt than the original duration of a tone, actual single play time is equal to the original duration.</p&gt </td&gt </tr&gt<tr&gt<td&gt255</td&gt <td&gtUse the last valid configuration value.</td&gt </tr&gt</table&gt
The following option values may be configured, in addition to values in the range 0 to 255 -:
...
<p&gtLight Effect Index for Endpoint 8 (Emergency)</p&gt
The following option values may be configured -:
...
<h1&gtKeep extinguished duration for Light Effect #1</h1&gt <table&gt<tr&gt<td&gt0 .. 255</td&gt <td&gtThe time of Indicator Light keep extinguished. (Unit = 100ms)</td&gt </tr&gt</table&gt
...
<h1&gtKeep bright duration for Light Effect #1</h1&gt <table&gt<tr&gt<td&gt0 .. 255</td&gt <td&gtThe time of Indicator Light keep bright. (Unit = 100ms)</td&gt </tr&gt</table&gt
Values in the range 0 to 255 may be set.
...
<h1&gtGradually extinguished duration for Light Effect #1</h1&gt <table&gt<tr&gt<td&gt0 .. 127</td&gt <td&gtThe time from Indicator Light bright to extinguished. (Unit = 20ms)</td&gt </tr&gt</table&gt
...
<h1&gtGradually bright duration for Light Effect #1</h1&gt <table&gt<tr&gt<td&gt0 .. 127</td&gt <td&gtThe time from Indicator Light extinguished to bright. (Unit = 20ms)</td&gt </tr&gt</table&gt
Values in the range 0 to 127 may be set.
...
<h1&gtKeep extinguished duration for Light Effect #2</h1&gt <table&gt<tr&gt<td&gt0 .. 255</td&gt <td&gtThe time of Indicator Light keep extinguished. (Unit = 100ms)</td&gt </tr&gt</table&gt
Values in the range 0 to 255 may be set.
...
<h1&gtKeep bright duration for Light Effect #2</h1&gt <table&gt<tr&gt<td&gt0 .. 255</td&gt <td&gtThe time of Indicator Light keep bright. (Unit = 100ms)</td&gt </tr&gt</table&gt
Values in the range 0 to 255 may be set.
...
<h1&gtGradually extinguished duration for Light Effect #2</h1&gt <table&gt<tr&gt<td&gt0 .. 127</td&gt <td&gtThe time from Indicator Light bright to extinguished. (Unit = 20ms)</td&gt </tr&gt</table&gt
Values in the range 0 to 127 may be set.
...
<h1&gtGradually bright duration for Light Effect #2</h1&gt <table&gt<tr&gt<td&gt0 .. 127</td&gt <td&gtThe time from Indicator Light extinguished to bright. (Unit = 20ms)</td&gt </tr&gt</table&gt
Values in the range 0 to 127 may be set.
...
<h1&gtKeep extinguished duration for Light Effect #3</h1&gt <table&gt<tr&gt<td&gt0 .. 255</td&gt <td&gtThe time of Indicator Light keep extinguished. (Unit = 100ms)</td&gt </tr&gt</table&gt
Values in the range 0 to 255 may be set.
...
<h1&gtKeep bright duration for Light Effect #3</h1&gt <table&gt<tr&gt<td&gt0 .. 255</td&gt <td&gtThe time of Indicator Light keep bright. (Unit = 100ms)</td&gt </tr&gt</table&gt
Values in the range 0 to 255 may be set.
...
<h1&gtGradually extinguished duration for Light Effect #3</h1&gt <table&gt<tr&gt<td&gt0 .. 127</td&gt <td&gtThe time from Indicator Light bright to extinguished. (Unit = 20ms)</td&gt </tr&gt</table&gt
Values in the range 0 to 127 may be set.
...
<h1&gtGradually bright duration for Light Effect #3</h1&gt <table&gt<tr&gt<td&gt0 .. 127</td&gt <td&gtThe time from Indicator Light extinguished to bright. (Unit = 20ms)</td&gt </tr&gt</table&gt
Values in the range 0 to 127 may be set.
...
<h1&gtKeep extinguished duration for Light Effect #4</h1&gt <table&gt<tr&gt<td&gt0 .. 255</td&gt <td&gtThe time of Indicator Light keep extinguished. (Unit = 100ms)</td&gt </tr&gt</table&gt
Values in the range 0 to 255 may be set.
...
<h1&gtKeep bright duration for Light Effect #4</h1&gt <table&gt<tr&gt<td&gt0 .. 255</td&gt <td&gtThe time of Indicator Light keep bright. (Unit = 100ms)</td&gt </tr&gt</table&gt
Values in the range 0 to 255 may be set.
...
<h1&gtGradually extinguished duration for Light Effect #4</h1&gt <table&gt<tr&gt<td&gt0 .. 127</td&gt <td&gtThe time from Indicator Light bright to extinguished. (Unit = 20ms)</td&gt </tr&gt</table&gt
Values in the range 0 to 127 may be set.
...
<h1&gtGradually bright duration for Light Effect #4</h1&gt <table&gt<tr&gt<td&gt0 .. 127</td&gt <td&gtThe time from Indicator Light extinguished to bright. (Unit = 20ms)</td&gt </tr&gt</table&gt
Values in the range 0 to 127 may be set.
...
<h1&gtKeep extinguished duration for Light Effect #5</h1&gt <table&gt<tr&gt<td&gt0 .. 255</td&gt <td&gtThe time of Indicator Light keep extinguished. (Unit = 100ms)</td&gt </tr&gt</table&gt
Values in the range 0 to 255 may be set.
...
<h1&gtKeep bright duration for Light Effect #5</h1&gt <table&gt<tr&gt<td&gt0 .. 255</td&gt <td&gtThe time of Indicator Light keep bright. (Unit = 100ms)</td&gt </tr&gt</table&gt
Values in the range 0 to 255 may be set.
...
<h1&gtGradually extinguished duration for Light Effect #5</h1&gt <table&gt<tr&gt<td&gt0 .. 127</td&gt <td&gtThe time from Indicator Light bright to extinguished. (Unit = 20ms)</td&gt </tr&gt</table&gt
Values in the range 0 to 127 may be set.
...
<h1&gtGradually bright duration for Light Effect #5</h1&gt <table&gt<tr&gt<td&gt0 .. 127</td&gt <td&gtThe time from Indicator Light extinguished to bright. (Unit = 20ms)</td&gt </tr&gt</table&gt
Values in the range 0 to 127 may be set.
...
<h1&gtKeep extinguished duration for Light Effect #6</h1&gt <table&gt<tr&gt<td&gt0 .. 255</td&gt <td&gtThe time of Indicator Light keep extinguished. (Unit = 100ms)</td&gt </tr&gt</table&gt
Values in the range 0 to 255 may be set.
...
<h1&gtKeep bright duration for Light Effect #6</h1&gt <table&gt<tr&gt<td&gt0 .. 255</td&gt <td&gtThe time of Indicator Light keep bright. (Unit = 100ms)</td&gt </tr&gt</table&gt
Values in the range 0 to 255 may be set.
...
<h1&gtGradually extinguished duration for Light Effect #6</h1&gt <table&gt<tr&gt<td&gt0 .. 127</td&gt <td&gtThe time from Indicator Light bright to extinguished. (Unit = 20ms)</td&gt </tr&gt</table&gt
Values in the range 0 to 127 may be set.
...
<h1&gtGradually bright duration for Light Effect #6</h1&gt <table&gt<tr&gt<td&gt0 .. 127</td&gt <td&gtThe time from Indicator Light extinguished to bright. (Unit = 20ms)</td&gt </tr&gt</table&gt
Values in the range 0 to 127 may be set.
...
<h1&gtKeep extinguished duration for Light Effect #7</h1&gt <table&gt<tr&gt<td&gt0 .. 255</td&gt <td&gtThe time of Indicator Light keep extinguished. (Unit = 100ms)</td&gt </tr&gt</table&gt
Values in the range 0 to 255 may be set.
...
<h1&gtKeep bright duration for Light Effect #7</h1&gt <table&gt<tr&gt<td&gt0 .. 255</td&gt <td&gtThe time of Indicator Light keep bright. (Unit = 100ms)</td&gt </tr&gt</table&gt
Values in the range 0 to 255 may be set.
...
<h1&gtGradually extinguished duration for Light Effect #7</h1&gt <table&gt<tr&gt<td&gt0 .. 127</td&gt <td&gtThe time from Indicator Light bright to extinguished. (Unit = 20ms)</td&gt </tr&gt</table&gt
Values in the range 0 to 127 may be set.
...
<h1&gtGradually bright duration for Light Effect #7</h1&gt <table&gt<tr&gt<td&gt0 .. 127</td&gt <td&gtThe time from Indicator Light extinguished to bright. (Unit = 20ms)</td&gt </tr&gt</table&gt
Values in the range 0 to 127 may be set.
...
<h1&gtNote:</h1&gt <ol&gt<li&gtCan trigger unpairing multiple Buttons at one time.</li&gt <li&gtUser does not need to do anything to Button.</li&gt <li&gtIndicator Light will quickly flash white light 3 times when Unpairing Button Mode finishes</li&gt </ol&gt
The following option values may be configured -:
...
<p&gtNote:</p&gt <ol&gt<li&gtCan NOT trigger pairing multiple Buttons at one time.</li&gt <li&gtPairing time is up to 10 seconds. In this time period, user MUST manually click Ring Button 3 times quickly. Otherwise it cannot be paired successfully.</li&gt <li&gtEach successful pairing will overwrite the previous paired Button which has the same Button Number.</li&gt </ol&gt
The following option values may be configured -:
...
<h1&gtNote:</h1&gt <p&gtOnce Pairing Button Mode is triggered, node will automatically send this configuration report via Lifeline to inform which Button is waiting for being paired.</p&gt
The following option values may be configured -:
...
<p&gtReport which Buttons had been paired (Read Only)</p&gt <h1&gtNote:</h1&gt <p&gtOnce Unpairing or Pairing Button Mode finishes, node will automatically send this configuration report via Lifeline to inform which Buttons had been paired.</p&gt <p&gtThis parameter does not restore to the default value when Chime is removed from the network or reset the factory settings.</p&gt
The following option values may be configured -:
...
<table&gt<tr&gt<td&gt<strong&gtValue</strong&gt</td&gt <td&gt<strong&gtDescription</strong&gt</td&gt </tr&gt<tr&gt<td&gt0</td&gt <td&gtButton is unpaired</td&gt </tr&gt<tr&gt<td&gt1 .. 65535</td&gt <td&gtFor example, if Button Software Version equals to 0x0100  (256), it means its version is 1.00.</td&gt </tr&gt</table&gt
...
<table&gt<tr&gt<td&gt<strong&gtValue</strong&gt</td&gt <td&gt<strong&gtDescription</strong&gt</td&gt </tr&gt<tr&gt<td&gt0</td&gt <td&gtButton is unpaired.</td&gt </tr&gt<tr&gt<td&gt1 .. 32767</td&gt <td&gtThe unit of Battery Voltage in mV .</td&gt </tr&gt</table&gt
...
<table&gt<tr&gt<td&gt<strong&gtValue</strong&gt</td&gt <td&gt<b&gtDescription</b&gt</td&gt </tr&gt<tr&gt<td&gt0</td&gt <td&gtButton is unpaired.</td&gt </tr&gt<tr&gt<td&gt1 .. 65535</td&gt <td&gtFor example, if Button Software Version equals to 0x0100 (256), it means its version is 1.00.</td&gt </tr&gt</table&gt
The following option values may be configured, in addition to values in the range 0 to 65535 -:
...
<table&gt<tr&gt<td&gt<strong&gtValue</strong&gt</td&gt <td&gt<strong&gtDescription </strong&gt</td&gt </tr&gt<tr&gt<td&gt0</td&gt <td&gtButton is unpaired.</td&gt </tr&gt<tr&gt<td&gt1 .. 32676</td&gt <td&gtThe unit of Battery Voltage is mV.</td&gt </tr&gt</table&gt
The following option values may be configured, in addition to values in the range 0 to 32767 -:
...
<p&gtEnable or Disable the ability that click the Action Button to stop a playing tone.</p&gt
The following option values may be configured -:
...
<table&gt<tr&gt<td&gt<strong&gtValue</strong&gt</td&gt <td&gt<strong&gtDescription</strong&gt</td&gt </tr&gt<tr&gt<td&gt1431655765 (0x55555555)</td&gt <td&gt<strong&gtFactory Reset:</strong&gt Restore the product to factory settings and remove from the network.</td&gt </tr&gt<tr&gt<td&gtOther</td&gt <td&gt<strong&gtInitialization:</strong&gt Initialize all configuration parameters to default values .</td&gt </tr&gt</table&gt<h1&gtNote:</h1&gt <p&gtParameter 51/52/53/54 will not restore the configuration settings to the default when Factory Reset or Initialization is performed.</p&gt
...
<ul&gt<li&gtDevice Reset Locally Notification: Issued when Factory Reset is performed .</li&gt <li&gtSound Switch Tone Play Report: Issued when a tone has started playing .</li&gt <li&gtSound Switch Configuration Report : Issued when volume or default tone has changed.</li&gt <li&gtNotification Report (Type=0x0E; Event=0x01): Issued when Chime starts playing tone.</li&gt <li&gtNotification Report (Type=0x0E; Event=0x00): Issued when Chime stops playing tone.</li&gt <li&gtNotification Report (Type=0x07; Event=0x09): Issued when Chime is tampered and moved.</li&gt <li&gtNotification Report (Type=0x08 ; Event=0x0A): Issued when Button is low battery.</li&gt <li&gtNotification Report (Type=0x0 8; Event=0x00): Issued when Button comes back to normal battery.</li&gt <li&gtConfiguration Report (Parameter=0x32): Issued when Pairing Button Mode is trig gered .</li&gt <li&gtConfiguration Report (Parameter=0x33): Issued when Unpairing or Pairing Button Mode finishes .</li&gt </ul&gt
...
Control: Key01
<p&gtMirror of endpoint 1, group 2</p&gt
...
Control: Key02
<p&gtMirror of endpoint 2, group 2</p&gt
...
Control: Key03
<p&gtMirror of endpoint 3, group 2</p&gt
...
Control: Key04
<p&gtMirror of endpoint 4, group 2</p&gt
...
Control: Key05
<p&gtMirror of endpoint 5, group 2</p&gt
...
Control: Key06
<p&gtMirror of endpoint 6, group 2</p&gt
...
Control: Key07
<p&gtMirror of endpoint 7, group 2</p&gt
...
Control: Key08
<p&gtMirror of endpoint 8 , group 2</p&gt
