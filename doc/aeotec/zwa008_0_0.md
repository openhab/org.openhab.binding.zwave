...
<p&gtAeotec Door/ Window Sensor 7 is a small window position sensor for your smart home, it monitors window and their exact opening position and lets your know when a window is tilted or completely opened. It also supports connecting external binary sensors through the dry binary contact of the Door/ Window sensor.</p&gt

### Inclusion Information

<p&gtTripple click the tamper switch<br /&gt<br /&gt</p&gt

### Exclusion Information

<p&gtTripple click the tamper switch </p&gt
...
<p&gtHit the tamper switch once.</p&gt
...
<p&gtThis parameter defines if the internal magnet sensor or the external terminal input is detected and used to issue alarm notification. There is always one input active only. The other sensor input the deactivated. </p&gt
...
<p&gtDisabling all indications may extend battery life.</p&gt <table&gt<tr&gt<td&gt<strong&gtSetting</strong&gt</td&gt <td&gt<strong&gtDescription</strong&gt</td&gt </tr&gt<tr&gt<td&gtByte 1: 00000001 </td&gt <td&gtNo Indications</td&gt </tr&gt<tr&gt<td&gtByte 1: 00000010 </td&gt <td&gtOpen/Close Status Change </td&gt </tr&gt<tr&gt<td&gtByte 1: 00000100 </td&gt <td&gtWake Up </td&gt </tr&gt<tr&gt<td&gtByte 1: 00010000</td&gt <td&gtDevice Tampering </td&gt </tr&gt</table&gt
...
<p&gtAllows to enable the activation of a Z-Wave range test with double clicking the tamper switch. </p&gt
The following option values may be configured -:
...
<p&gtThis parameter defines the status of the magnet switch that causes sending a BASIC command to all devices of Association Group 2 </p&gt
The following option values may be configured -:
