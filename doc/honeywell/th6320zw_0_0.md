...
<p&gtThe Honeywell T6 Pro Z-Wave Programmable Thermostat lets you program and control your home’s HVAC system as well as control other Z-Wave devices connected to the same Z-Wave controller.</p&gt <p&gtDisplays ambient air temperature, % relative indoor humidity and reports HVAC system status.</p&gt

### Inclusion Information

<p&gtAfter inclusion procedure has been initiated on your Z-Wave controller, touch Select on the thermostat.</p&gt

### Exclusion Information

<p&gtAfter exclusion procedure has been initiated on your Z-Wave controller, touch Select on the thermostat.</p&gt
