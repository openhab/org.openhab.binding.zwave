...
<p&gtHeating thermostat with LCD Screen, adopt z-wave technology to realize remote and manual control. The thermostat is recommended for the control of electric heating device or on/off valve actuator used in hydronic heating.</p&gt

### Inclusion Information

<p&gtPress "Manual" button three times in two seconds, "wireless" icon will start to blink</p&gt
