...
<p&gtMonitor activities at your home with this Z-Wave Door and Window Sensor.  Choose to receive mobile or email alerts when a door or window is opened.  Use the Door/Window sensor to trigger video recording or turn on the lights.  View the status of the sensor from your smartphone, tablet, or computer.</p&gt

### Inclusion Information

<p&gtRemove the battery for 10 seconds and replace the battery to restart enrollment mode.</p&gt
...
<p&gtEnable or disable Basic Sets of 0x00 on a fault restore to nodes in Group 2. Default = Enabled.</p&gt
