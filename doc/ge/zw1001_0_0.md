...
<p&gtOnce the controller is ready to include your device, press and release the Program Button to include it in the network.</p&gt

### Exclusion Information

<p&gtPress and release the Program Button to exlude it from the network.</p&gt
...
<p&gtDefault is LED on when switch is off.</p&gt
