...
<p&gtZ-wave controlled AC outlet for standard incandescent lighting, CFL/LEDs, fans or small appliances.<br /&gtMust not exceed 600 watts (Incandescent); 1800W (15A) Resistive or ½ HP Motor </p&gt

### Inclusion Information

<p&gtPut controller into inclusion mode, single press and release the manual/program button on the smart switch to include it in the network</p&gt

### Exclusion Information

<p&gtPut controller into exclusion mode, single press and release the manual/program button on the smart switch to exclude it from the network</p&gt
...
<p&gtThis device will send a Basic Set Message directly to whatever Z-wave device you have mapped this setting to when you single press the on/off button. For example, if you map this setting to a wall switch and then single press the on/off button on this "Plug in Smart Switch," a corresponding on/off message will be sent directly to that wall switch, bypassing openHAB.</p&gt
...
<p&gtThis device will send a Basic Set Message directly to whatever Z-wave device you have mapped this setting to when you double press the on/off button. For example, if you map this setting to a wall switch and then double press the on/off button on this "Plug in Smart Switch," a corresponding on/off message will be sent directly to that wall switch, bypassing openHAB.</p&gt
