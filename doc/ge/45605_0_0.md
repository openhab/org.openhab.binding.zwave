...
<p&gtOnce the controller is ready to add your device, press and release the Program Button to add it in the network.</p&gt
...
### Night Light
<p&gtDefines the behaviour of the blue LED</p&gt <p&gt0 = LED on when switch is OFF</p&gt <p&gt1 = LED on when switch is ON</p&gt <p&gt2 = LED always OFF</p&gt
