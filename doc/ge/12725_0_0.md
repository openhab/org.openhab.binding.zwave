...
<p&gtRF controlled, in-wall 1000w dimmer, interchangeable paddle</p&gt

### Inclusion Information

<p&gtPress and release the top or bottom of the dimmer smart switch (rocker) to add it in the network.</p&gt

### Exclusion Information

<p&gtPress and release the top or bottom of the dimmer smart switch (rocker) to remove it from the network.</p&gt
...
Invert Switch
<p&gtInvert the ON/OFF Switch State.</p&gt <p&gtSetting this parameter to Yes will change the top of the switch to OFF and the bottom to ON. </p&gt <p&gtNote: If you invert the switches and also install the product upside down, the load will now be control</p&gt
The following option values may be configured -:
...
<p&gtIndicates how many levels the dimmer will change for each dimming step.</p&gt
...
<p&gtThis value indicates in 10 millisecond resolution This sets how often the dim level will change.</p&gt <p&gtFor example, if you set this parameter to 1, then every 10ms the dim level will change.</p&gt <p&gtIf you set it to 255, then every 2.55 seconds the dim level will change.</p&gt
