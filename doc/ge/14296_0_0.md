...
<p&gtOnce the controller is ready to add your device, press up and release the toggle.</p&gt

### Exclusion Information

<p&gtOnce the controller is ready to remove your device, press up and release the toggle.</p&gt <p&gt<strong&gtNOTE: If  Advanced configuration parameter 19 is changed, the above process is incorrect.</strong&gt</p&gt
