...
<p&gtOnce the controller is ready to remove your device, press and release the manual/program button to remove it from the network.</p&gt
...
<p&gt0 - LED On when load is Off, Led Off when load is On</p&gt <p&gt1 - LED On when load is On, LED Off when laod is Off (Default)</p&gt <p&gt2 - LED always off</p&gt
...
<p&gtSupports Basic Set and is controlled with the local load</p&gt
