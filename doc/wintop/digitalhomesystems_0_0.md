...
No device information is provided in the database. Consider [updating the database](https://www.opensmarthouse.org/zwavedatabase/634) to improve the documentation.
...
You can [contribute to the database here](https://www.opensmarthouse.org/zwavedatabase/634).
