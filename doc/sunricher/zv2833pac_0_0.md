...
The following table provides a summary of the 9 configuration parameters available in the ZV2833PAC.
Detailed information on each parameter can be found in the sections below.

| Param | Name  | Description |
|-------|-------|-------------|
| 0 | Scenes sent to the controller for button 3 | Scenes sent to the controller for button 3 |
...
### Parameter 0: Scenes sent to the controller for button 3
