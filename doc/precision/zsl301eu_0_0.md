...
<p&gtSwitch Link is a power ON/OFF module purposed to control lighting lamps or motor loads.</p&gt

### Inclusion Information

<p&gtWhen prompted by your primary controller, press the button</p&gt
...
Delay In Time
<p&gt0   ->  The light will be ON instantaneously once ON command is received.</p&gt <p&gt1 - 5   ->  The module will detain the ON process for 1-5 seconds up to user preferences.</p&gt
...
Delay Out Time
<p&gt0   ->  The light will be OFF instantaneously once OFF command is received.</p&gt <p&gt1 - 5   ->  The module will detain the OFF process for 1-5 seconds up to user preferences.</p&gt
Values in the range 0 to 5 may be set.
