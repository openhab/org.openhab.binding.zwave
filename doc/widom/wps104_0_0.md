...
<p&gtWiDom Energy Driven Switch is a device designed to monitor all <b&gtparameters</b&gt, <b&gtusage</b&gt, <b&gtfaults</b&gt and <b&gtoverloads </b&gtof your electrical system. Unlike an ordinary energy meter, WiDom Energy Driven Switch can be installed to monitor an entire electricity network or a section of the latter.</p&gt <p&gt·         <b&gtActive Energy-saving management</b&gt</p&gt <p&gtAutomatically connects and disconnects a specific load if the established threshold limit is exceeded, or supplies the required power, momentarily excluding non-priority loads.</p&gt <p&gt·         <b&gtManagement and prevention of electrical faults </b&gt</p&gt <p&gtIdentifies malfunctions based on irregular consumptions and to the maximum time of activity.</p&gt <p&gt·         <b&gtElectrical overload management </b&gt</p&gt <p&gtNotifies or disconnects non-priority loads in the eventuality of system overloads.</p&gt

### Inclusion Information

<p&gtIf the device is not included into a Z-Wave network, a single click on the (B) button or on the external switch will launch the process of traditional inclusion. If the device inclusion procedure does not start within 2 seconds, the Network Wide Inclusion network will be launched lasting a variable amount of time between 15-30 seconds</p&gt

### Exclusion Information

<p&gtOnly a controller can remove a device from the network. WiDom Energy Driven Switch is compatible with all Z-Wave certified controllers. After the exclusion procedure has been activated by the controller, the device can be removed, putting it in <i&gtExclusion</i&gt <i&gtMode</i&gt by three consecutive clicks on the (B) button or on the external switch, when available.</p&gt
...
<p&gtControlling the relay by means of a single click on the external switch or on the integrated button.</p&gt
...
<p&gtThe final status achieved by the device when it receives a <b&gt<i&gtBasic Set</i&gt</b&gt command through the Z-Wave network.</p&gt
The following option values may be configured -:
...
<p&gtSets the current level above which the time spent above that level is measured.</p&gt <p&gtVersion C: From 0 to 4500[1] hundredths of Amperes – Default Value: <b&gt4500 Hundredths of Amperes</b&gt</p&gt <p&gtVersion S: From 0 to 1250 hundredths of Amperes – Default Value: <b&gt1250 Hundredths of Amperes</b&gt</p&gt
...
<p&gtSets the time beyond which, in the case of overcurrent at a level higher than that established in parameter 30, an OverCurrent event occurs.</p&gt <p&gtFrom 0 to 10800 Seconds (3 Hours) – Default Value: <b&gt10 Seconds</b&gt</p&gt
...
<p&gtDefines the next state of the device if an overcurrent event has occurred</p&gt
The following option values may be configured -:
...
<p&gtProvides total operating time from last meter reset. When set to 0 it resets the cumulative values of energy and total operating time.</p&gt
The following option values may be configured -:
...
<p&gtDetermines whether energy events are related to energy consumed or energy produced.</p&gt
The following option values may be configured -:
...
<p&gtThe upper limit power threshold detector determines when instantaneous power remains above the threshold point (UP Power Level) beyond a specified duration (UP Power Time). When this happens, a <i&gtUP Power Event</i&gt occurs.</p&gt <p&gtSets the level of instantaneous power in Watts beyond which time of permanence above this level is calculated. </p&gt <p&gtVersion C: From 0 to 11250[1] – Default value: <b&gt11250 </b&gt</p&gt <p&gtVersion S: From 0 to 3000 – Default value: <b&gt3000 </b&gt</p&gt
...
<p&gtSets the time in seconds beyond which, if instantaneous power remains at levels exceeding threshold defined by parameter 35, a UP Power event occurs.</p&gt <p&gtFrom 0 to 10800 seconds (3 Hours) – Default value: <b&gt10 Seconds</b&gt</p&gt
Values in the range 0 to 10800 may be set.
...
<p&gtDefines the next status of the device in the case of a UP Power event occurring.</p&gt
The following option values may be configured -:
...
<p&gtDefines the status of associated devices in the presence of a UP Power event.</p&gt <p&gtFrom: 1 to 99 for dimming purpose</p&gt <p&gt0 (OFF) and -1(ON) for switching ON/OFF.</p&gt <p&gtDefault: <b&gt0 – OFF</b&gt</p&gt
...
Sets the level of instantaneous power in Watts
<p&gtSets the level of instantaneous power beyond which the time of permanence below this level is calculated.</p&gt <p&gtFrom 0 to 11250 Watt – Default value: <b&gt0 W</b&gt</p&gt
Values in the range 0 to 11250 may be set.
...
Sets the time in seconds
<p&gtSets the time beyond which, if instantaneous power remains at levels below threshold defined by parameter 39, a DOWN Power event occurs.      From 0 to 10800 Seconds (3 Hours) – Default value: <b&gt10 Seconds</b&gt</p&gt
Values in the range 0 to 10800 may be set.
...
<p&gtDefines the next state of the device in the case of a DOWN Power event occurring.</p&gt
The following option values may be configured -:
...
<p&gtDefines the status of associated devices in the presence of a DOWN Power event.</p&gt <p&gtFrom: 1 to 99 for dimming purpose</p&gt <p&gt– 0 (OFF) and -1(ON) for switching ON/OFF.</p&gt <p&gtDefault: <b&gt0 – OFF</b&gt</p&gt
Values in the range -1 to 99 may be set.
...
<p&gtSets the energy level that once exceeded an Energy Limit event occurs<b&gt.</b&gt</p&gt <p&gtFrom 0 to 2.000.000 KWh – Default value: <b&gt2.000.000 KWh</b&gt</p&gt
...
<p&gtDefines the next state of the device in the case of an Energy Limit event occurring.</p&gt
The following option values may be configured -:
...
<p&gtDefines the percentage variation of instantaneous power determining the sending of the report<b&gt. </b&gt</p&gt <p&gtFrom: 1 (1%) to 100 (100%) Default value: <b&gt10 – 10%</b&gt</p&gt
...
<p&gtDefines the maximum time in minutes since the previous report beyond which an Instantaneous Power Report will still be sent.</p&gt <p&gtFrom: 1 to 100 minutes. Default value: <b&gt10 minutes</b&gt</p&gt
Values in the range 1 to 100 may be set.
...
<p&gtDefines the increase of total energy required to generate a report listing the level of total energy to the devices associated to the Energy Notification Group</p&gt
The following option values may be configured -:
...
<p&gtDefines the nominal voltage value in tenths of volts. Together with parameter No. 49 this is used by the automatic notification system to send reports on variations of voltage.</p&gt <p&gtDefault value: <b&gt2300</b&gt</p&gt <p&gtFrom: 1100 to 2500</p&gt
...
<p&gtDefines, as a percentage, the nominal value for permitted fall in maximum voltage.</p&gt <p&gtFrom: 1 (1%) to 100 (100%) Default value: <b&gt10 – 10%</b&gt</p&gt
Values in the range 1 to 100 may be set.
...
<p&gtDefines which electric parameters, other than power, will be subjected to automatic notification.</p&gt <p&gtThe value to be set for this parameter must be calculated as the sum of values associated to the individual electric parameter indicated in the table of Manual.</p&gt <p&gtTo send report only for Power please set the value to 0.</p&gt <p&gtTo send report only for Power and Energy please set the value to 2 (0+2).</p&gt <p&gtTo send report for Power, Energy, Voltage, Current, Power Factor please set the value to 30 (0+2+4+8+16).</p&gt <p&gtBy default the report are sent for (Power, Energy, Voltage, Current, Power Factor) 0+2+4+8+16à30</p&gt <p&gtDefault value: <b&gt30</b&gt</p&gt <p&gtPermitted values: From 0 to 62</p&gt
...
<p&gtReading of this parameter returns the value of voltage RMS at the time of the reading expressed in tenths of Volts.</p&gt
...
<p&gtDevices who will receive notification on: status changes; energy level and power;  local reset of the device</p&gt <p&gtReceived commands: Basic Report, Device Reset Locally Notification, Meter Report, Multilevel Sensor: Power Report</p&gt

Association group 1 supports 8 nodes.

### Group 2: Up Power Level Group

<p&gtDevices controlled from Up Power Event</p&gt

Association group 2 supports 8 nodes.

### Group 3: Down Power Level Group

<p&gtDevices controlled from Down Power Event</p&gt
