...
<ul&gt<li&gt Intelligently Connected with Alarm.com (Alarm.com account required) </li&gt <li&gt Remote Access and Control </li&gt <li&gt Custom Schedules </li&gt <li&gt Critical Temperature Alerts and Geo-Services Automation </li&gt <li&gt Can be paired with Alarm.com Temperature Sensor ADC-S2000-T-RA for enhanced climate control and improved energy savings (sold separately) </li&gt </ul&gt

### Inclusion Information

<p&gtPut thermostat in OFF mode (no mode icons are lit)</p&gt <p&gtPress and hold the DOWN button to begin inclusion mode. Release when the RADIO icon lights up.</p&gt <p&gtWhen the RADIO icon becomes solid, the thermostat has been included.</p&gt

### Exclusion Information

<p&gtPut thermostat in OFF mode (no mode icons are lit)</p&gt <p&gtPress and hold the DOWN button to begin exclusion mode. Release when the RADIO icon lights up.</p&gt <p&gtWhen the RADIO icon flashes red, the thermostat has been excluded.</p&gt
...
<p&gt0 - Normal (Default)</p&gt <p&gt1 - Heat Pump</p&gt
...
<p&gt0 - Fossil Fuel</p&gt <p&gt1 - Electric (Default)</p&gt
The following option values may be configured -:
...
<p&gt0 - Comfort</p&gt <p&gt1 - Efficient (Default)</p&gt
The following option values may be configured -:
...
<p&gt0 - Disabled (Default)</p&gt <p&gt1 - Enabled</p&gt
The following option values may be configured -:
...
<p&gt0 - Celsius</p&gt <p&gt1 - Farenheit (Default)</p&gt
The following option values may be configured -:
...
<p&gt3 - Off, Heat<br /&gt5 - Off, Cool<br /&gt7 - Off, Heat, Cool<br /&gt15 - Off, Heat, Cool, Auto (Default)<br /&gt19 - Off, Heat, Emergency Heat<br /&gt23 - Off, Heat, Cool, Emergency Heat<br /&gt31 - Off, Heat, Cool, Auto, Emergency Heat</p&gt
The following option values may be configured -:
...
<p&gt0 - Disabled (Default)<br /&gt1 - W3 - Third Stage HEAT or 2nd Stage of 2-Stage Auxiliary / Backup heat<br /&gt2 - H - External Dehumidifier Control<br /&gt3 - DH - External Dehumidifier Operation</p&gt
The following option values may be configured -:
...
<p&gt0 - Battery (Default)</p&gt <p&gt1 - C-Wire</p&gt
The following option values may be configured -:
...
<p&gt0 - Disabled (Default)</p&gt <p&gt1 - Enabled</p&gtThis is an advanced parameter and will therefore not show in the user interface without entering advanced mode.
The following option values may be configured -:
...
<p&gt0 - O/B Terminal acts as B terminal, closed when cooling<br /&gt1 - O/B Terminal acts as O terminal, closed when heating (Default)</p&gtThis is an advanced parameter and will therefore not show in the user interface without entering advanced mode.
The following option values may be configured -:
