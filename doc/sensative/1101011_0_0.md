...
<p&gtStrips is a Z-Wave magnet sensor that can be added to any certified Z-Wave system and operate with any brand Z-Wave device.</p&gt

### Inclusion Information

<ul&gt<li&gtSet your controller in inclusion mode (see your controller’s manual).</li&gt <li&gtFollow the instruction for Wake up.</li&gt <li&gtA long LED blink indicates that the inclusion was successful.</li&gt </ul&gt

### Exclusion Information

<ul&gt<li&gtSet your controller in exclusion mode (see your controller’s manual).</li&gt <li&gtFollow the instruction for Wake up.</li&gt <li&gtA long LED blink indicates that the exclusion was successful.</li&gt </ul&gt
...
<p&gtWake up Strips manually for Z-Wave communication.</p&gt <ul&gt<li&gtPlace the round magnet at the rounded edge.</li&gt <li&gtWhen the LED blinks, move the magnet away.</li&gt <li&gtRepeat 3 times in total within 10 seconds.</li&gt </ul&gt<p&gtIt may be necessary to repeat this process several times to make changes take affect.</p&gt <p&gtNote that wakeup period can only be set to a minimum period of 30 minutes.</p&gt
