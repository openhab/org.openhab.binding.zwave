...
## Channels
The following table summarises the channels available for the MT02647 Devolo Motion Sensor.
...
The following table provides a summary of the configuration parameters available in the MT02647 Devolo Motion Sensor.
