...
<p&gtThe Aeon Labs Smart Energy Switch is a Z-Wave appliance switch which can report wattage energy usage or kWh energy usage to a Z-Wave gateway. It can also be controlled by other Z-Wave devices to turn on/off to save electricity when appropriate.</p&gt

### Inclusion Information

<ol&gt<li&gtPlug the Smart Energy Switch into an outlet</li&gt <li&gtPut the controller in inclusion mode</li&gt <li&gtPress the button located between the LED</li&gt </ol&gt<p&gtIf the Aeon Labs Smart Energy Switch was not successfully included into any Z-Wave network, the LED will be blinking. If the Aeon Labs Smart Energy Switch was successfully included to a Z-Wave network, the LED will either be on or off (depending on if the switch is on or off). </p&gt

### Exclusion Information

<ol&gt<li&gtPut the controller in exclusion mode</li&gt <li&gtPress the button located between the LED</li&gt </ol&gt<p&gtIf the Aeon Labs Smart Energy Switch was removed from the Z-Wave network, the LED will be blinking. If the Aeon Labs Smart Energy Switch was not successfully removed from the Z-Wave network, the LED will either be on or off (depending on if the switch is on or off). </p&gt
...
<p&gtEnables automatic notifications to associated devices whenever there is a state change</p&gt (0=nothing, 1=hail CC, 2=basic CC report)
The following option values may be configured -:
