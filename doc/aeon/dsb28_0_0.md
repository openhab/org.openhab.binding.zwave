...
<p&gtAeon Labs Home Energy Meter is a kind of energy meter for the entire home electric power consumption. It can report immediate wattage and kWh and voltage and amperage usage of the AC mains to a Z-Wave gateway wirelessly.</p&gt <p&gtIt can send Z-Wave REPORTS (Meter v3 Command Class) to response Z-Wave GET command at any time.</p&gt <p&gtHEM can also be configured as sending unsolicited reports periodically to the associated nodes (within an association group). The time interval of reports can also be configured HEM can also send report of each individual channel with corresponding current clamp via the command of “Multi Channel Command Class Encapsulation ”.</p&gt <p&gtTo reduce the network traffic, HEM can send reports only when the loads significant change occurred(by percentage or Wattage value change, which can be configured)</p&gt

### Inclusion Information

<ol&gt<li&gtConnect HEM G2 to power and install the device properly (according to the Installation instruction, if necessary, please ask an electrician for help) , at beginning its LED blink slowly.</li&gt <li&gtLet the primary controller of existing Z-Wave network into inclusion mode (If you don’t know how to do this, refer to its manual).</li&gt <li&gtPress the Z-Wave button of HEM G2.</li&gt <li&gtIf learning success, HEM G2 LED will stop slow blink, or it will still slow blink, please repeat the process from step 2. </li&gt </ol&gt

### Exclusion Information

<ol&gt<li&gtMake sure the HEM G2 is powered, its LED be light on steadily.</li&gt <li&gtLet the primary controller of existing Z-Wave network into remove mode (If you don’t know how to do this, refer to its manual).</li&gt <li&gtPress the Z-Wave button.</li&gt <li&gtIf exclusion success, HEM G2 LED will blink slowly or its LED still be on, please repeat the process from step 2.</li&gt </ol&gt

### General Usage Information

<p&gtReset HEM G2 to factory Default:</p&gt <ol&gt<li&gtMake sure HEM G2 has been connected to the power supply.</li&gt <li&gtPress and hold the Z-wave button for 10 seconds.</li&gt <li&gtIf HEM G2 LED blinks slowly, it indicates reset success, otherwise please repeat step 2.</li&gt </ol&gt<p&gtNote:</p&gt <p&gtReset HEM G2 to factory default Settings will: sets the HEM G2 to not in Z-Wave network state; delete the Association setting, power measure value and restore the Configuration Settings to the default.</p&gt
...
<p&gtEnable selective reporting only when power change reaches a certain threshold or percentage set in 4-11 below.</p&gt <p&gtThis is used to reduce network traffic.(Bit 0: Whole HEM ,Bit 1:Clamp 1,Bit 2:Clamp 2,Bit 3:Clamp 3)</p&gt
...
<p&gtThreshold change in wattage to induce a automatic report (Clamp 1). (Valid values 0-60000)</p&gt
Values in the range 0 to 60000 may be set.
...
<p&gtThreshold change in wattage to induce a automatic report (Clamp 2). (Valid values 0-60000)</p&gt
Values in the range 0 to 60000 may be set.
...
<p&gtThreshold change in wattage to induce a automatic report (Clamp 3). (Valid values 0-60000)</p&gt
Values in the range 0 to 60000 may be set.
...
<p&gtPercentage change in wattage to induce a automatic report (Whole HEM). (Valid values 0-100)</p&gt
...
<p&gtPercentage change in wattage to induce a automatic report (Clamp 1). (Valid values 0-100)</p&gt
Values in the range 0 to 100 may be set.
...
<p&gtPercentage change in wattage to induce a automatic report (Clamp 2). (Valid values 0-100)</p&gt
Values in the range 0 to 100 may be set.
...
<p&gtPercentage change in wattage to induce a automatic report (Clamp 3). (Valid values 0-100)</p&gt
Values in the range 0 to 100 may be set.
...
Reports for group 1
<p&gt1 -> Battery Report<br /&gt<br /&gt2 -> MultiSensor Report for the whole device<br /&gt<br /&gt4 -> Meter Report for Watt for the whole device<br /&gt<br /&gt8 -> Meter Report for kWh for the whole device<br /&gt<br /&gt256 -> Meter Report for Watt for clamp 1<br /&gt<br /&gt512 -> Meter Report for W</p&gt
...
<p&gtIf you upgrade firmware and are seeing crazy or impossible numbers, reset to factory then reconfigure unit.</p&gtThis is an advanced parameter and will therefore not show in the user interface without entering advanced mode.
The following option values may be configured -:
