...
<p&gtAeon Labs Siren is a switch binary device based on Z-wave enhanced 232 slave library of V6.51.01. </p&gt

### Inclusion Information

<ol&gt<li&gtPress and release the Action button. LED will blink for 3 seconds.</li&gt <li&gtIf successfully included, LED will no longer blink after the Action button is quickly pressed.</li&gt </ol&gt

### Exclusion Information

<ol&gt<li&gtPress and release the Action button. </li&gt <li&gtIf successfully removed, LED will blink for 3 seconds after the Action button is quickly pressed.</li&gt </ol&gt
...
<p&gtThe Value1(low byte) is used to select the Siren sound. The Value2(high byte) is used to adjust the volume. Other values will be ignored. 0 1  ->   do not change the current sound.1 1  ->   Siren sound 1 is selected.2 1  ->   Siren sound 2 i</p&gtThis is an advanced parameter and will therefore not show in the user interface without entering advanced mode.
...
<p&gtEnable to send notifications to associated devices when the state of Siren changed.</p&gt
The following option values may be configured -:
