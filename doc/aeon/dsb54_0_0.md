...
<p&gtAeotec Recessed Door Sensor Gen5 has been crafted to power connected lighting using Z-Wave Plus. </p&gt

### Inclusion Information

<ol&gt<li&gtPlace your gateway or controller into Z-Wave pair or inclusion mode.</li&gt <li&gtPress the Action Button on your Sensor.</li&gt <li&gtIf your Sensor has been successfully linked to your network, its LED will become solid for 2 seconds then disappear. If linking was unsuccessful, the LED will continue to blink if you tap its button.</li&gt </ol&gt

### Exclusion Information

<ol&gt<li&gtPlace your gateway or controller into Z-Wave unpair or exclusion mode</li&gt <li&gtPress the Action Button on your Sensor.</li&gt <li&gtIf your switch has been successfully unlinked to your network, its LED will begin to blink for a short time. If linking was unsuccessful, the LED will return to its last state. Tap the button to confirm if it has been unpaired, if unpaired successfully, the LED will blink when tapped.</li&gt </ol&gt
...
<p&gtPress and hold the Z-Wave button for 6 seconds</p&gt

### General Usage Information

<p&gtReset:</p&gt <p&gtAt some stage, you may wish to reset all of your Recessed Door Sensor's settings to their factory defaults. </p&gt <ul&gt<li&gtTo do this, press and hold the Action Button for 20 seconds and then release it. Your sensor will now be reset to its original settings</li&gt </ul&gt
...
<p&gt1, Value=0x55555555、Default=1、Size=4<br /&gt2, Value=0、Default=1、Size=1 Reset all configuration<br /&gtparameters (except the parameter 254) to default settings.<br /&gt3, Other values will be reserved.</p&gt
Values in the range 0 to 65535 may be set.
