...
<p&gtKey Fob Gen5 is a fully functional Z-wave remote controller, which can include, exclude and control the other Z-Wave certified devices. It also can be acted a secondary controller in a network.</p&gt

### Inclusion Information

<p&gtShort press the “Include” button on the Key Fob, it will go into inclusion state and its blue LED will blink slowly to wait including other slave Z-Wave devices.</p&gt

### Exclusion Information

<p&gtShort press the “Remove” button, the Key Fob will go into exclusion state and its red LED will blink slowly to wait excluding any other Z‐wave device from its network.</p&gt
...
<p&gtPress and hold the “Learn” button for 3 seconds, which will trigger to send a Wake Up Notification CC and Node info frame.</p&gt
