...
<p&gtThe Aeon Labs Micro SES is a binary power switch device based on Zwave enhanced slave library V5.02P3.</p&gt
...
<p&gtAutomated sending of a Report triggered by minimal change of value.</p&gt
The following option values may be configured -:
...
<p&gtWhich reports need to send automatically in timing intervals for group 1</p&gt
Values in the range 0 to 65535 may be set.
...
<p&gtWhich reports need to send automatically in timing intervals for group 2</p&gt
Values in the range 0 to 65535 may be set.
...
<p&gtWhich reports need to send automatically in timing intervals for group 3</p&gt
Values in the range 0 to 65535 may be set.
