...
<p&gtThe Aeon Labs MultiSensor is a routing binary sensor device based on Zwave routing slave library V5.03.  </p&gt

### Inclusion Information

<p&gtPress the tamper button 3 times rapidly.</p&gt

### Exclusion Information

<p&gtPress the tamper button 3 times rapidly.</p&gt <p&gtNOTE:</p&gt <p&gtAs soon as the MultiSensor is removed from a z-wave network it will restore itself to factory settings. </p&gt
...
<p&gtThe value is a combination number made up of the sum of the values for the individual sensors and battery.</p&gt <p&gtThe sensors have the values:</p&gt <p&gtTemperature=32</p&gt <p&gtHumidity=64</p&gt <p&gtLightlevel=128</p&gt <p&gtBattery=1                           </p&gt <p&gtTherefore if you want all sensors and the battery report set this value to <strong&gt225</strong&gt (recommended)</p&gt
...
<p&gtThe value is a combination number made up of the sum of the values for the individual sensors and battery.</p&gt <p&gtThe sensors have the values:</p&gt <p&gtTemperature=32</p&gt <p&gtHumidity=64</p&gt <p&gtLightlevel=128</p&gt <p&gtBattery=1                           </p&gt <p&gtTherefore if you want all sensors and the battery report set this value to 225</p&gt
Values in the range 0 to 225 may be set.
