...
<p&gtThere are appliances that we turn on and off in our homes each day. And, despite the fact that it'd save us money, there are those that we could turn off if only it was easier. Aeotec by Aeon Labs’ Smart Switch (2nd Edition) and Switch (2nd Edition) package convenience, control and money saving considerations into one, small, plug-in tool. A tool that can be programmed, scheduled, controlled and communicated with from anywhere in the wor</p&gt

### Inclusion Information

<ol&gt<li&gtPress the Action Button on your switch.</li&gt <li&gtIf your switch has been successfully linked to your network, its LED will no longer blink. If the linking was unsuccessful the LED will continue to blink. </li&gt </ol&gt

### Exclusion Information

<ol&gt<li&gtPress the Action Button on your switch.</li&gt <li&gtIf your switch has been successfully removed from your network, its LED will blink. If the removal was unsuccessful its LED will not blink</li&gt </ol&gt
