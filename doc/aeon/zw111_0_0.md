...
<p&gtset notification sent to associated nodes (group 3)</p&gt <p&gtTo set which notification would be sent to the associated nodes in association Group 3 when using the external switch 1 to switch the loads.</p&gt
The following option values may be configured -:
