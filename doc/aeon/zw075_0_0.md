...
<p&gtSmart Energy Switch 3rd Edition</p&gt <ul&gt<li&gtRemotely turn connected device on/off to save electricity</li&gt <li&gtReports wattage consumption or kwh energy usage</li&gt <li&gtSmall size to help minimize blocking of other AC outlets</li&gt </ul&gt

### Inclusion Information

<p&gtPut your controller into inclusion mode. Press the Action Button on your switch. If your switch has been successfully linked to your network, its LED will no longer blink. If the linking was unsuccessful the LED will continue to blink.</p&gt

### Exclusion Information

<p&gtPut your controller into exclusion mode. Press the Action Button on your switch. If your switch has been successfully removed from your network, its LED will blink. If the removal was unsuccessful its LED will not blink.</p&gt
...
<p&gtThe LSB defines the total time the device need to blink. The value if set in seconds. 1 - 255 The MSB defines the on/off interval of the blinking. The unit is 0.1 s. This is a double byte value.</p&gt
...
<p&gt Load will be closed when the Current over runs (US: 15.5A, other country: 16.2A) for more than 2 minutes.</p&gt
...
<p&gtEnable device to send notification to associated devices (Group 1) when the state of Micro Smart Switch's load changed. DEFAULT is Disable</p&gt
The following option values may be configured -:
...
<p&gtEnable the device to send notification to associated devices (Group 1) when the state of the Micro Smart Switch's load changed</p&gt
The following option values may be configured -:
...
<p&gtUsers, who want a more constant monitoring of power consumption should set this value to 1. The reporting period is by default quite long ( approx. 35minutes)</p&gt
The following option values may be configured -:
...
<p&gtThe value represents the minimum change in Wattage Percent for a report to be sent. Range is 0 to 100%</p&gt
...
<p&gt Enable/Disable automated sending of report triggered by minimal change of value.</p&gt
The following option values may be configured -:
...
<p&gtThe value is a combination number made up of the sum of the values for the individual parameters.</p&gt <p&gtThe parameters have the values: KWH=8, Wattage=4, Current=2, Voltage=1.</p&gt <p&gtTherefore if you want all parameters sending regular r</p&gt
Values in the range 0 to 65535 may be set.
...
The value is a combination number
<p&gtThe value is a combination number made up of the sum of the values for the individual parameters.</p&gt <p&gtThe parameters have the values: KWH=8, Wattage=4, Current=2, Voltage=1.</p&gt <p&gt Therefore if you want all parameters sending regular re</p&gt
Values in the range 0 to 65535 may be set.
...
The value is a combination number
<p&gtThe value is a combination number <br> made up of the sum of the values for the individual parameters. <br> The parameters have the values: KWH=8, Wattage=4, Current=2, Voltage=1. <br> Therefore if you want all parameters sending regular re</p&gt
Values in the range 0 to 65535 may be set.
...
<p&gtDefines the time interval when the defined report of Reporting Group 1 is sent out.</p&gt <p&gt0 s - 65535 s - Interval</p&gt
Values in the range 0 to 65535 may be set.
...
<p&gtDefines the time interval when the defined report of Reporting Group 2 is sent out.</p&gt <p&gt0 s - 65535 s - Interval</p&gt
Values in the range 0 to 65535 may be set.
...
<p&gtDefines the time interval when the defined report of Reporting Group 3 is sent out.</p&gt <p&gt0 s - 65535 s - Interval</p&gt
Values in the range 0 to 65535 may be set.
