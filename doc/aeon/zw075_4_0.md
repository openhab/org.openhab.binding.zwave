...
<p&gtSmart Energy Switch 5th Edition</p&gt <ul&gt<li&gtRemotely turn connected device on/off to save electricity</li&gt <li&gtReports wattage consumption or kwh energy usage</li&gt <li&gtSmall size to help minimize blocking of other AC outlets</li&gt </ul&gt
...
<p&gtThis device can be used to monitor power usage as well as remotely control the state of power to whatever is plugged into the device.</p&gt
...
<p&gtLoad will be closed when the Current over runs (US: 15.5A, other country: 16.2A) for more than 2 minutes.</p&gt
...
<p&gtThe value is a combination number made up of the sum of the values for the individual parameters.</p&gt <p&gtThe parameters have the values: KWH=8, Wattage=4, Current=2, Voltage=1.</p&gt <p&gtTherefore if you want all parameters sending regular reports, set the value to 15</p&gt
Values in the range 0 to 65535 may be set.
...
<p&gtDetermines whether or not the device is OEM or white label.</p&gt <p&gt0 is OEM; 1 and above are a repackaged products for other companies.</p&gt
