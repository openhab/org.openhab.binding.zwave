...
<p&gtThe Aeon Labs Micro Motor Controller is a Motor Control Class C Specific Device which is connected with window rail to remote control curtain to any position that you want directly.</p&gt

### Inclusion Information

<p&gtClick the Zwave button once.</p&gt
...
<p&gtDisables Function of automated sending of a Report triggered by minimal change of value.</p&gt
The following option values may be configured -:
...
<p&gtThe value is a combination number made up of the sum of the values for the individual parameters. The parameters have the values:</p&gt <ul&gt<li&gtWattage=4</li&gt <li&gtCurrent=2</li&gt <li&gtVoltage=1</li&gt </ul&gt
Values in the range 0 to 65535 may be set.
