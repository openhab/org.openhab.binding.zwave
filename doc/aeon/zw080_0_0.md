...
### Sound and Volume
<p&gtValue 1 (LSB) Sound (bits 0-4), Value 2 (MSB) volume (bits 0-2)</p&gt
...
<p&gtEnable to send notifications to associated devices (Group1) when the state of Siren changed (0=nothing,1=hailCC,2=basic CC report).</p&gt
