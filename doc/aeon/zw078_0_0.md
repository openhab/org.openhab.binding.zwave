...
<p&gtWall mounted switch for high current appliances, up to 40A. Power reporting.</p&gt

### Inclusion Information

<p&gtPress the Action Button on your Heavy Duty Smart Switch</p&gt <p&gtIf your switch has been successfully linked to your Z-Wave network, its Status LED will no longer blink. If the linking was unsuccessful, the Status LED continues to blink.</p&gt

### Exclusion Information

<p&gtPress the Action Button on your Heavy Duty Smart Switch.</p&gt <p&gtIf your Heavy Duty Smart Switch has been successfully removed from your network, its Status LED will blink. If the removal was unsuccessful, its Status LED will not blink.</p&gt
...
<p&gtThis is the temperature of the circuit board. The sensor is inside the case at the top of the unit.</p&gt
...
<p&gtParameter to Enable to send notification to associated devices (Group 1) when the state of Micro Smart Switch's load changed</p&gt
The following option values may be configured -:
...
<p&gtParameter to Enable/Disable automated sending of a Report triggered by minimal change of value.</p&gt
The following option values may be configured -:
...
<p&gtThe value represents the minimum change in Wattage Percent for a report to be sent.</p&gt
...
See overview
<p&gtThe value is a combination number made up of the sum of the values for the individual parameters.                                                       </p&gt <p&gtThe parameters have the values: KWH=8, Wattage=4, Current=2, Voltage=1.                          </p&gt
Values in the range 0 to 65535 may be set.
...
<p&gtThe Node IDs in Group 1 will receive Hail Command/Basic report (configurable) when Heavy Duty Smart Switch Gen5's level changed.</p&gt

Association group 1 supports 5 nodes.

### Group 2: Group 2

<p&gtWhen the Heavy Duty Smart Switch Gen5 receives the commands Basic Set, Switch Binary Set, or Scene Activation Set it will forward the commands to all node IDs (in Group 2).</p&gt
