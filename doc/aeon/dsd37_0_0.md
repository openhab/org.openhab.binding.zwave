...
* [User Manual](https://www.opensmarthouse.org/zwavedatabase/66/20-Range-Extender--Repeater-.pdf)
* [Engineering Manual](https://www.opensmarthouse.org/zwavedatabase/66/z-wave-plus-aeotec-range-extender-engineering-sheet.pdf)

---

Did you spot an error in the above definition or want to improve the content?
You can [contribute to the database here](https://www.opensmarthouse.org/zwavedatabase/66).
