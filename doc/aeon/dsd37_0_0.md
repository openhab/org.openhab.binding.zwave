...
<p&gtAeon Labs Range Extender is a Z-Wave repeater device based on Z-Wave enhanced 232 slave library V6.51.08.</p&gt <p&gtIt can extend the range of the communication between Z-Wave products and assist other devices to reach each other in your Z-Wave network.</p&gt <p&gtIt can be included and operated in any Z-wave network with other Z-wave certified devices from other manufacturers and/or other applications. All non-battery operated nodes within the network will act as repeaters regardless of vendor to increase reliability of the network.</p&gt <p&gtIt is also a security Z-Wave device and supports the Over The Air (OTA) feature for the product’s firmware upgrade.  </p&gt

### Inclusion Information

<p&gtFor Non-Security Inclusion, Press the button one time.</p&gt <p&gtFor Security Inclusion, Press the button two times</p&gt <p&gtIf the inclusion is successful, its Network LED will be solid when you press the Action Button again.</p&gt

### Exclusion Information

<p&gtPress the button one or two times.</p&gt <p&gtIf the exclusion is successful, its Network LED will be colorful gradient status</p&gt
