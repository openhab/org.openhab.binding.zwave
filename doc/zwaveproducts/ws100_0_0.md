...
<ul&gt<li&gtWorks with incandescent and dimmable florescent (CFL) or most LED lighting</li&gt <li&gtON/OFF status and location LED indicator</li&gt <li&gtFits into standard single or multiple gang junction box</li&gt <li&gtOver-The-Air firmware upgrade available with compatible gateway, Z-Wave static controller, or PC and software</li&gt <li&gtInternal resettable fuse to protect from surge current</li&gt <li&gtManual reset capability</li&gt <li&gtSupport Central Scene</li&gt </ul&gt

### Inclusion Information

<p&gtingle click and release the rocker switch to ON or OFF position.</p&gt

### Exclusion Information

<p&gtsingle click and release the rocker switc</p&gt
