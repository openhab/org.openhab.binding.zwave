...
<p&gtDoor/Window sensor with LED indicator, battery powered.</p&gt

### Inclusion Information

<p&gtPress Z-Wave button once to wake up the device then once to connect to Z-Wave network</p&gt

### Exclusion Information

<p&gtPress Z-Wave button once to wake up the device then once to disconect from Z-Wave network</p&gt
...
<p&gtPress Z-Wave button once to wake up the device</p&gt
