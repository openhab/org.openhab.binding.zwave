...
/**
 * Class to implement the Z-Wave command class <b>COMMAND_CLASS_ZWAVEPLUS_INFO</b> version <b>1</b>.<br>
 *
    ...
    static public byte[] getZwaveplusInfoReport(Integer zWavePlusVersion, String roleType, String nodeType) {
        ...
        switch (nodeType) {
            case "NODE_TYPE_ZWAVEPLUS_NODE":
                outputData.write(0x00);
                break;
            case "NODE_TYPE_ZWAVEPLUS_FOR_IP_ROUTER":
                outputData.write(0x01);
                break;
            case "NODE_TYPE_ZWAVEPLUS_FOR_IP_GATEWAY":
                outputData.write(0x02);
                break;
            case "NODE_TYPE_ZWAVEPLUS_FOR_IP_CLIENT_IP_NODE":
                outputData.write(0x03);
                break;
            case "NODE_TYPE_ZWAVEPLUS_FOR_IP_CLIENT_ZWAVE_NODE":
                outputData.write(0x04);
                break;
            default:
    ...
    public static Map<String, Object> handleZwaveplusInfoReport(byte[] payload) {
        ...
        switch (payload[4]) {
            case (byte) 0x00:
                ...
                break;
            case (byte) 0x01:
                response.put("NODE_TYPE", "NODE_TYPE_ZWAVEPLUS_FOR_IP_ROUTER");
                break;
            case (byte) 0x02:
                response.put("NODE_TYPE", "NODE_TYPE_ZWAVEPLUS_FOR_IP_GATEWAY");
                break;
            case (byte) 0x03:
                response.put("NODE_TYPE", "NODE_TYPE_ZWAVEPLUS_FOR_IP_CLIENT_IP_NODE");
                break;
            case (byte) 0x04:
                response.put("NODE_TYPE", "NODE_TYPE_ZWAVEPLUS_FOR_IP_CLIENT_ZWAVE_NODE");
                break;
            default:
