    ...
    public enum ZWaveRegion {
        ...
        public static ZWaveRegion fromLocale(Locale locale) {
            ...
            if ("AT".equals(country) || "BE".equals(country) || "BG".equals(country) || "HR".equals(country)
                    || "CY".equals(country) || "CZ".equals(country) || "DK".equals(country) || "EE".equals(country)
                    || "FI".equals(country) || "FR".equals(country) || "DE".equals(country) || "GR".equals(country)
                    || "HU".equals(country) || "IE".equals(country) || "IT".equals(country) || "LV".equals(country)
                    || "LT".equals(country) || "LU".equals(country) || "MT".equals(country) || "NL".equals(country)
                    || "PL".equals(country) || "PT".equals(country) || "RO".equals(country) || "SK".equals(country)
                    || "SI".equals(country) || "ES".equals(country) || "SE".equals(country) || "GB".equals(country)) {
                return EU;
            }
