...
An online logviewer that presents the log file in a clearer way in order to help understanding the logs is available [here](https://www.cd-jackson.com/index.php/openhab/zwave-log-viewer).
